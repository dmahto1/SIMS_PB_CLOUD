...
//sqlca.dbparm="Database='"+sqlca.database+"',TrimSpaces=1,DisableBind=1,TrustServerCertifi$$HEX1$$ad00$$ENDHEX$$cate=1,DelimitIdentifier=1,OJSyntax='ANSI',ProviderString='MultipleActiveResultSets=False; OLE DB Services=-4'" 
