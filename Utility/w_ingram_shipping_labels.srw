HA$PBExportHeader$w_ingram_shipping_labels.srw
$PBExportComments$ingram Shipping labels
forward
global type w_ingram_shipping_labels from w_main_ancestor
end type
type cb_print from commandbutton within w_ingram_shipping_labels
end type
type dw_label from u_dw_ancestor within w_ingram_shipping_labels
end type
type cb_selectall from commandbutton within w_ingram_shipping_labels
end type
type cb_clear from commandbutton within w_ingram_shipping_labels
end type
end forward
...
global w_ingram_shipping_labels w_ingram_shipping_labels
...
For llRowPos = 1 to llRowCount /*each detail row */
	...
	Lstrparms.String_arg[14] = dw_label.object.ship_ref[llRowPos]
	Lstrparms.String_arg[15] = dw_label.object.transport_mode[llRowPos]
	Lstrparms.String_arg[17] = dw_label.object.delivery_master_invoice_no[llRowPos]
	Lstrparms.String_arg[18] = dw_label.object.freight_terms[llRowPos]
	...
	// Print Text on Last Label
	If llLabelof = llLabelCount Then 
		lstrparms.String_Arg[19] = 'PACKING SLIP'
		lstrparms.String_Arg[20] = 'ENCLOSED'
	Else
		lstrparms.String_Arg[19] = ''
		lstrparms.String_Arg[20] = ''
	End If
	...
	lsAny=lstrparms		
	invo_labels.uf_ingram_shipping_intermec(lsAny)
...
on w_ingram_shipping_labels.create
int iCurrent
call super::create
...
on w_ingram_shipping_labels.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_ingram_shipping_labels
...
type cb_ok from w_main_ancestor`cb_ok within w_ingram_shipping_labels
integer x = 1769
integer y = 24
integer height = 80
