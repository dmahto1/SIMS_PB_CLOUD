HA$PBExportHeader$w_import.srw
...
Choose case isLayout
	...
	//24-Apr-2017 :Madhu PEVS-567- KNY$$HEX2$$13202000$$ENDHEX$$Custom Wave Plan input sheet -START
	Case "wave-plan"
		dw_import =Create u_dw_import_wave_plan
		dw_import.dataobject ='d_baseline_unicode_generic_import'
	//24-Apr-2017 :Madhu PEVS-567- KNY$$HEX2$$13202000$$ENDHEX$$Custom Wave Plan input sheet -END
...
////								//a.	If found bring it to the import screen.  Since these are all $$HEX1$$1820$$ENDHEX$$H; type what are we doing on the adjustment? 
////								//Do we set new/old inventory type = $$HEX1$$1820$$ENDHEX$$H$$HEX2$$19202000$$ENDHEX$$just like the location and qty?
...
If Not ibValError Then
	...
	//Jxlim 04/23/2011 This window  is  shared by all import data windows most of which don$$HEX1$$1920$$ENDHEX$$t have these column, therefore add a specific call for min_max dataobject only.
