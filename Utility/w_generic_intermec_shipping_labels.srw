HA$PBExportHeader$w_generic_intermec_shipping_labels.srw
$PBExportComments$Generic Intermec Shipping labels
forward
global type w_generic_intermec_shipping_labels from w_main_ancestor
end type
type cb_print from commandbutton within w_generic_intermec_shipping_labels
end type
type dw_label from u_dw_ancestor within w_generic_intermec_shipping_labels
end type
type cb_selectall from commandbutton within w_generic_intermec_shipping_labels
end type
type cb_clear from commandbutton within w_generic_intermec_shipping_labels
end type
end forward
...
global w_generic_intermec_shipping_labels w_generic_intermec_shipping_labels
...
For llRowPos = 1 to llRowCount /*each detail row */
	...
	lsAny=lstrparms		
	invo_labels.uf_generic_intermec_shipping_label(lsAny)
...
on w_generic_intermec_shipping_labels.create
int iCurrent
call super::create
...
on w_generic_intermec_shipping_labels.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_generic_intermec_shipping_labels
...
type cb_ok from w_main_ancestor`cb_ok within w_generic_intermec_shipping_labels
integer x = 1769
integer y = 24
integer height = 80
