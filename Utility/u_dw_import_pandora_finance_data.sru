HA$PBExportHeader$u_dw_import_pandora_finance_data.sru
$PBExportComments$Import Supplier Information
forward
global type u_dw_import_pandora_finance_data from u_dw_import
end type
end forward
...
integer width = 3077
integer height = 1572
string dataobject = "d_import_pandora_finance_data"
end type
global u_dw_import_pandora_finance_data u_dw_import_pandora_finance_data
...
on u_dw_import_pandora_finance_data.create
call super::create
end on

on u_dw_import_pandora_finance_data.destroy
call super::destroy
end on
