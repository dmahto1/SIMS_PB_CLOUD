HA$PBExportHeader$w_maquet_part_labels.srw
$PBExportComments$Maquet part labels
forward
global type w_maquet_part_labels from w_main_ancestor
end type
type cb_print from commandbutton within w_maquet_part_labels
end type
type dw_label from u_dw_ancestor within w_maquet_part_labels
end type
type cb_selectall from commandbutton within w_maquet_part_labels
end type
type cb_clear from commandbutton within w_maquet_part_labels
end type
end forward
...
integer width = 3237
integer height = 1812
string title = "Maquet Part Labels"
string menuname = ""
event ue_print ( )
cb_print cb_print
dw_label dw_label
...
global w_maquet_part_labels w_maquet_part_labels
...
If lsLabelPrint > "" Then
	...
	lsPrintText = 'Maquet Part Labels '
...
on w_maquet_part_labels.create
int iCurrent
call super::create
...
on w_maquet_part_labels.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_maquet_part_labels
boolean visible = false
integer x = 1938
integer y = 1392
integer height = 80
...
type cb_ok from w_main_ancestor`cb_ok within w_maquet_part_labels
integer x = 1769
integer y = 32
integer height = 80
integer textsize = -9
