HA$PBExportHeader$w_scitex_shipping_labels.srw
$PBExportComments$Print Scitex Shipping labels
forward
global type w_scitex_shipping_labels from w_main_ancestor
end type
type cb_print from commandbutton within w_scitex_shipping_labels
end type
type dw_label from u_dw_ancestor within w_scitex_shipping_labels
end type
type cb_selectall from commandbutton within w_scitex_shipping_labels
end type
type cb_clear from commandbutton within w_scitex_shipping_labels
end type
end forward
...
global w_scitex_shipping_labels w_scitex_shipping_labels
...
For llRowPos = 1 to llRowCount /*each detail row */
	...
	Lstrparms.String_arg[18] = String(dw_label.GetItemDateTime(llRowPos,'request_date'),'mm/dd/yy') /* PO NBR*/
	Lstrparms.String_arg[19] = dw_label.object.last_user[llRowPos]
	Lstrparms.String_arg[20] = dw_label.object.agent_info[llRowPos]
	...
	Lstrparms.String_arg[34] = dw_label.GetItemString(llRowPos,'user_field4') 
	Lstrparms.Long_arg[1] = llQty /*Qty of labels to print*/
	
	lsAny=lstrparms		
	invo_labels.uf_scitex_zebra_ship(lsAny)
...
on w_scitex_shipping_labels.create
int iCurrent
call super::create
...
on w_scitex_shipping_labels.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_scitex_shipping_labels
...
type cb_ok from w_main_ancestor`cb_ok within w_scitex_shipping_labels
integer x = 1769
integer y = 24
integer height = 80
...
integer height = 1456
boolean bringtotop = true
string dataobject = "d_scitex_shipping_label"
