HA$PBExportHeader$w_geistlich_bs_shipping_labels.srw
$PBExportComments$Geistlich - Buffalo Sypply -  Shipping labels
forward
global type w_geistlich_bs_shipping_labels from w_main_ancestor
end type
type cb_print from commandbutton within w_geistlich_bs_shipping_labels
end type
type dw_label from u_dw_ancestor within w_geistlich_bs_shipping_labels
end type
type cb_selectall from commandbutton within w_geistlich_bs_shipping_labels
end type
type cb_clear from commandbutton within w_geistlich_bs_shipping_labels
end type
end forward
...
global w_geistlich_bs_shipping_labels w_geistlich_bs_shipping_labels
...
For llRowPos = 1 to llRowCount /*each detail row */
	...
	Lstrparms.String_arg[29] = dw_label.GetItemString(llRowPos,'Warehouse_country')
	...
	Lstrparms.String_arg[30] = dw_label.GetItemString(llRowPos,'delivery_master_country')
	...
	Lstrparms.String_arg[19] = dw_label.GetItemString(llRowPos,'user_field2')
	Lstrparms.String_arg[20] = dw_label.GetItemString(llRowPos,'user_field19')
	Lstrparms.String_arg[21] = dw_label.object.delivery_master_do_no[llRowPos]
	Lstrparms.String_arg[25] = dw_label.GetItemString(llRowPos,'user_field15')
	Lstrparms.String_arg[34] = dw_label.GetItemString(llRowPos,'user_field5') 
	Lstrparms.Long_arg[1] = llQty /*Qty of labels to print*/
	
	lsAny=lstrparms		
	invo_labels.uf_geistlich_bs_zebra_ship(lsAny)
...
on w_geistlich_bs_shipping_labels.create
int iCurrent
call super::create
...
on w_geistlich_bs_shipping_labels.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_geistlich_bs_shipping_labels
...
type cb_ok from w_main_ancestor`cb_ok within w_geistlich_bs_shipping_labels
integer x = 1769
integer y = 24
integer height = 80
...
integer height = 1456
boolean bringtotop = true
string dataobject = "d_geistlich_bs_shipping_label"
