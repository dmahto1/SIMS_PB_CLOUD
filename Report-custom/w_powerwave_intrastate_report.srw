HA$PBExportHeader$w_powerwave_intrastate_report.srw
$PBExportComments$OutBound Order Report (GAP - 8/02)
forward
global type w_powerwave_intrastate_report from w_std_report
end type
type uo_order_status_search from uo_multi_select_search within w_powerwave_intrastate_report
end type
end forward
...
integer width = 3566
integer height = 2100
string title = "Powerwave Intrastate Report"
uo_order_status_search uo_order_status_search
end type
global w_powerwave_intrastate_report w_powerwave_intrastate_report
...
on w_powerwave_intrastate_report.create
int iCurrent
call super::create
...
on w_powerwave_intrastate_report.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_powerwave_intrastate_report
event process_enter pbm_dwnprocessenter
integer x = 0
integer y = 0
integer width = 3419
integer height = 464
string dataobject = "d_powerwave_outbound_order_search"
...
type cb_clear from w_std_report`cb_clear within w_powerwave_intrastate_report
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_powerwave_intrastate_report
integer x = 5
integer y = 460
integer width = 3429
integer height = 1400
integer taborder = 30
string dataobject = "d_powerwave_intrastate_report"
