HA$PBExportHeader$w_stryker_instrument_loaner_report.srw
$PBExportComments$Stock Movement Report for All SKU's by Date range
forward
global type w_stryker_instrument_loaner_report from w_std_report
end type
end forward
...
integer width = 5019
integer height = 3032
string title = "Stryker Instrument Loaner Issued - Customer Wise Report"
end type
global w_stryker_instrument_loaner_report w_stryker_instrument_loaner_report
...
on w_stryker_instrument_loaner_report.create
call super::create
end on

on w_stryker_instrument_loaner_report.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_stryker_instrument_loaner_report
...
type cb_clear from w_std_report`cb_clear within w_stryker_instrument_loaner_report
...
type dw_report from w_std_report`dw_report within w_stryker_instrument_loaner_report
integer x = 14
integer y = 360
integer width = 4919
integer height = 2464
integer taborder = 30
string dataobject = "d_stryker_instrument_loaner_report"
