HA$PBExportHeader$w_3com_stock_movement_rpt_by_date.srw
$PBExportComments$Stock Movement Report for All SKU's by Date range
forward
global type w_3com_stock_movement_rpt_by_date from w_std_report
end type
end forward
...
integer width = 3488
integer height = 2044
string title = "3COM Stock Movement Report"
end type
global w_3com_stock_movement_rpt_by_date w_3com_stock_movement_rpt_by_date
...
on w_3com_stock_movement_rpt_by_date.create
call super::create
end on

on w_3com_stock_movement_rpt_by_date.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_3com_stock_movement_rpt_by_date
integer x = 18
integer width = 3131
...
type cb_clear from w_std_report`cb_clear within w_3com_stock_movement_rpt_by_date
integer x = 3154
integer y = 12
integer width = 270
end type
...
type dw_report from w_std_report`dw_report within w_3com_stock_movement_rpt_by_date
integer y = 188
integer width = 3401
integer height = 1704
string dataobject = "d_3com_stock_movement_rpt_by_date"
