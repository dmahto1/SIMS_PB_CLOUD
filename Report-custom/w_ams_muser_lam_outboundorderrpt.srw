HA$PBExportHeader$w_ams_muser_lam_outboundorderrpt.srw
$PBExportComments$AMS LAM Outbound Orders
forward
global type w_ams_muser_lam_outboundorderrpt from w_std_query_window
end type
end forward

global type w_ams_muser_lam_outboundorderrpt from w_std_query_window
string title = "  AMS OUTBOUND ORDER REPORT (LAM)"
end type
global w_ams_muser_lam_outboundorderrpt w_ams_muser_lam_outboundorderrpt
...
on w_ams_muser_lam_outboundorderrpt.create
call super::create
end on

on w_ams_muser_lam_outboundorderrpt.destroy
call super::destroy
...
//	see w_gm_last_on_hand_rpt for an example of this.
	...
	lstrparms.string_arg[2] = 'd_ams_muser_lam_order_report'
	...
	// Search shared with ams-muser reort but we don;t want supplier as part of criteria on this report
...
type dw_select from w_std_query_window`dw_select within w_ams_muser_lam_outboundorderrpt
end type

type cb_clear from w_std_query_window`cb_clear within w_ams_muser_lam_outboundorderrpt
end type

type dw_report from w_std_query_window`dw_report within w_ams_muser_lam_outboundorderrpt
end type
