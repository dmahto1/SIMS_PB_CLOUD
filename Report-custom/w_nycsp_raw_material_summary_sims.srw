HA$PBExportHeader$w_nycsp_raw_material_summary_sims.srw
$PBExportComments$AMS Multi User CMR Report
forward
global type w_nycsp_raw_material_summary_sims from w_std_report
end type
end forward
...
integer width = 3653
integer height = 2356
string title = "NYCSP Raw Material Summary In SIMS"
end type
global w_nycsp_raw_material_summary_sims w_nycsp_raw_material_summary_sims
...
on w_nycsp_raw_material_summary_sims.create
call super::create
end on

on w_nycsp_raw_material_summary_sims.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_nycsp_raw_material_summary_sims
...
type cb_clear from w_std_report`cb_clear within w_nycsp_raw_material_summary_sims
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_nycsp_raw_material_summary_sims
integer x = 32
integer y = 12
integer width = 3483
integer height = 2056
integer taborder = 30
string dataobject = "d_nycsp_raw_material_summary_sims"
