HA$PBExportHeader$w_riverbed_inbound_order_rpt.srw
$PBExportComments$This is the Inbound Order report
forward
global type w_riverbed_inbound_order_rpt from w_std_report
end type
end forward
...
global w_riverbed_inbound_order_rpt w_riverbed_inbound_order_rpt
...
on w_riverbed_inbound_order_rpt.create
call super::create
end on

on w_riverbed_inbound_order_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_riverbed_inbound_order_rpt
integer x = 0
integer width = 3575
integer height = 316
...
type cb_clear from w_std_report`cb_clear within w_riverbed_inbound_order_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_riverbed_inbound_order_rpt
integer x = 0
integer y = 332
integer width = 4370
integer height = 1852
integer taborder = 30
string dataobject = "d_riverbed_inbound_order_rpt"
