HA$PBExportHeader$w_lmc_delivery_note_rpt.srw
$PBExportComments$LMC Delivery Note report
forward
global type w_lmc_delivery_note_rpt from w_std_report
end type
end forward
...
integer width = 3653
integer height = 2356
string title = "LMC Delivery Note"
end type
global w_lmc_delivery_note_rpt w_lmc_delivery_note_rpt
...
on w_lmc_delivery_note_rpt.create
call super::create
end on

on w_lmc_delivery_note_rpt.destroy
call super::destroy
...
If isNUll(isDONO) or  isDoNO = '' Then
	Messagebox('Labels','You must have an order retrieved in the Delivery Order Window~rbefore you can print the Delivery Note!')
	Return
End If

//Pack list must be generated
If w_do.idw_pack.RowCount() = 0 Then
	Messagebox('Labels','You must generate the Pack List before you can print the Delivery Note!')
	Return
End If
...
type dw_select from w_std_report`dw_select within w_lmc_delivery_note_rpt
...
type cb_clear from w_std_report`cb_clear within w_lmc_delivery_note_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_lmc_delivery_note_rpt
integer x = 32
integer y = 12
integer width = 3483
integer height = 2056
integer taborder = 30
string dataobject = "d_lmc_delivery_note_rpt"
