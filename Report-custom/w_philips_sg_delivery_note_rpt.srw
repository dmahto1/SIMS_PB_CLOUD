HA$PBExportHeader$w_philips_sg_delivery_note_rpt.srw
$PBExportComments$Philips Singapore Delivery Note
forward
global type w_philips_sg_delivery_note_rpt from w_std_report
end type
end forward
...
global w_philips_sg_delivery_note_rpt w_philips_sg_delivery_note_rpt
...
//	end if
	...
	if dw_report.dataobject = "d_philips_sg_return_note" then
...
if gs_project = 'FUNAI' or gs_project = 'GIBSON' then
		...
		Case "SG00"
			...
			//nxjain Chnage d company registration code 199705989C to 196900610Z   
			dw_report.SetITem(llNewRow,'company_registration','196900610Z')
		Case "SG03"
...
Choose case upper(gs_project)
	...
	CASE 'FUNAI', 'GIBSON'  //TAM 2015/01/26 Added Gibson
...
on w_philips_sg_delivery_note_rpt.create
call super::create
end on

on w_philips_sg_delivery_note_rpt.destroy
call super::destroy
...
If isVAlid(w_do) Then
	...
	If w_do.idw_Main.GetITEmString(1,'wh_Code') = 'PHILIPS-MY' or w_do.idw_Main.GetITEmString(1,'wh_Code') = 'TPV-MY'  or w_do.idw_Main.GetITEmString(1,'wh_Code') = 'FUNAI-MY'  or w_do.idw_Main.GetITEmString(1,'wh_Code') = 'GIBSON-MY'  Then /* 01/13 - PCONKL - added TPV */  /* 6/13 - MEA - added FUNAI */ /*TAM 2015/01/26 Added Gibson*/
		dw_report.dataobject = 'd_philips_my_delivery_note'
	Else
		dw_report.dataobject = 'd_philips_sg_delivery_note'
	End IF	
...
ElseIf isVAlid(w_ro) Then /*Return Order*/
	...
	If w_ro.idw_Main.GetITEmString(1,'wh_Code') = 'PHILIPS-MY' or w_ro.idw_Main.GetITEmString(1,'wh_Code') = 'TPV-MY'  or w_ro.idw_Main.GetITEmString(1,'wh_Code') = 'FUNAI-MY'  or w_ro.idw_Main.GetITEmString(1,'wh_Code') = 'GIBSON-MY'    Then /* 01/13 - PCONKL - added TPV */  /* 6/13 - MEA - added FUNAI */ /*TAM 2015/01/26 Added Gibson*/
		dw_report.dataobject = 'd_philips_my_return_note'
	Else
		dw_report.dataobject = 'd_philips_sg_return_note'
	End IF	
...
//	End If
	...
	if dw_report.dataobject = "d_philips_sg_delivery_note" then
		dw_report.SetITem(llNewRow,'supp_code',lsSupplier)	
	end if
...
type dw_select from w_std_report`dw_select within w_philips_sg_delivery_note_rpt
...
integer width = 2624
integer height = 116
string dataobject = "d_philips_sg_delivery_note_weights"
...
type cb_clear from w_std_report`cb_clear within w_philips_sg_delivery_note_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_philips_sg_delivery_note_rpt
integer x = 0
integer y = 140
integer width = 3483
integer height = 1908
