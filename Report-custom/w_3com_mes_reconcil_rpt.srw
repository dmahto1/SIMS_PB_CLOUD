HA$PBExportHeader$w_3com_mes_reconcil_rpt.srw
$PBExportComments$3COM MES Reconciliation Report
forward
global type w_3com_mes_reconcil_rpt from w_std_report
end type
end forward
...
integer width = 3529
integer height = 2120
string title = "MES Reconciliation Report"
end type
global w_3com_mes_reconcil_rpt w_3com_mes_reconcil_rpt
...
on w_3com_mes_reconcil_rpt.create
call super::create
end on

on w_3com_mes_reconcil_rpt.destroy
call super::destroy
...
llRowCount = dw_report.Retrieve(gs_project, ldtFrom, ldtTo)
...
type dw_select from w_std_report`dw_select within w_3com_mes_reconcil_rpt
integer x = 0
integer width = 3067
integer height = 116
...
type cb_clear from w_std_report`cb_clear within w_3com_mes_reconcil_rpt
integer x = 3150
integer y = 12
integer width = 297
integer taborder = 20
...
type dw_report from w_std_report`dw_report within w_3com_mes_reconcil_rpt
integer x = 14
integer y = 128
integer width = 3438
integer height = 1740
integer taborder = 30
string dataobject = "d_3com_mes_reconcil_rpt"
