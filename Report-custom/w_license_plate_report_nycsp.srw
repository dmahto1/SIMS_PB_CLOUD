HA$PBExportHeader$w_license_plate_report_nycsp.srw
forward
global type w_license_plate_report_nycsp from w_std_report
end type
end forward
...
integer width = 3488
integer height = 2044
string title = "License Plate Report"
end type
global w_license_plate_report_nycsp w_license_plate_report_nycsp
...
on w_license_plate_report_nycsp.create
call super::create
end on

on w_license_plate_report_nycsp.destroy
call super::destroy
...
ll_cnt = dw_report.Retrieve(gs_project, ls_sku,ls_whcode, ls_cont,ls_floc,ls_tloc)  //01-Apr-2014 :Madhu - added
...
type dw_select from w_std_report`dw_select within w_license_plate_report_nycsp
integer x = 18
integer width = 3131
string dataobject = "d_license_plate_search_nycsp"
...
type cb_clear from w_std_report`cb_clear within w_license_plate_report_nycsp
integer x = 3154
integer y = 12
integer width = 270
end type
...
type dw_report from w_std_report`dw_report within w_license_plate_report_nycsp
integer y = 188
integer width = 3401
integer height = 1704
string dataobject = "d_license_plate_report_nycsp"
