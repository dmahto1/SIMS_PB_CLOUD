HA$PBExportHeader$w_comcast_sik_batch_report.srw
forward
...
For i = 1 to ll_ordercount
		...
		//	If dw_Report.Find("order_nbr = '" + ls_ordernbr + "'",1,ll_ordercount) > 0 Then Continue			
		   ...
		   //2. Letter Gen //If Delivery_Master.User_Field2 = $$HEX1$$1820$$ENDHEX$$Y$$HEX2$$19202000$$ENDHEX$$(See above), Then set $$HEX1$$1820$$ENDHEX$$Letter Gen$$HEX2$$19202000$$ENDHEX$$to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$. Otherwise set to $$HEX1$$1820$$ENDHEX$$N$$HEX1$$1920$$ENDHEX$$. 									
				// If SKU 
				...
				Else
					...
					End If	
				End If
		   //3. Pick //If there are delivery_Picking Records for the order (Records on the Pick list tab for that order number), Set $$HEX1$$1820$$ENDHEX$$Picked$$HEX2$$19202000$$ENDHEX$$to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$. Otherwise, set to $$HEX1$$1820$$ENDHEX$$N$$HEX1$$1920$$ENDHEX$$
		  ...
		  //4. UPS Lbl //If Delivery_Packing.Trax_Ship_Ref_Nbr > $$HEX3$$182019202000$$ENDHEX$$Then set $$HEX2$$18202000$$ENDHEX$$UPS Lbl$$HEX2$$19202000$$ENDHEX$$to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$, otherwise set to $$HEX1$$1820$$ENDHEX$$N$$HEX1$$1920$$ENDHEX$$. This field can be found on the TRAX tab (Do a find on Order Nummber)
		...
		//5. Serial # Scanned	
		//If There are Delivery_Serial_Detail records and the number of serial Numbers = The Picked Qty, set $$HEX2$$18202000$$ENDHEX$$Ser # Scanned$$HEX2$$19202000$$ENDHEX$$to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$. Otherwise set to $$HEX1$$1820$$ENDHEX$$N$$HEX1$$1920$$ENDHEX$$. 
		//This will need to be pulled from the database. 
		//Compare the Sum of the picked Qty (Select Sum(quantity) from delivery_Picking where do_no = <order nbr from detail tab> $$HEX2$$1c202000$$ENDHEX$$to 
		...
		//If they equal, set to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$. Otherwise set to $$HEX1$$1820$$ENDHEX$$N$$HEX1$$1920$$ENDHEX$$.
