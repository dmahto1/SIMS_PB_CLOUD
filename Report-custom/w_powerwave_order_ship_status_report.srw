HA$PBExportHeader$w_powerwave_order_ship_status_report.srw
$PBExportComments$OutBound Order Report (GAP - 8/02)
forward
global type w_powerwave_order_ship_status_report from w_std_report
end type
type uo_order_status_search from uo_multi_select_search within w_powerwave_order_ship_status_report
end type
end forward
...
integer width = 3566
integer height = 2100
string title = "PowerWave Order Shipment Status Report"
uo_order_status_search uo_order_status_search
end type
global w_powerwave_order_ship_status_report w_powerwave_order_ship_status_report
...
on w_powerwave_order_ship_status_report.create
int iCurrent
call super::create
...
on w_powerwave_order_ship_status_report.destroy
call super::destroy
...
//	If dw_select.GetItemString(1, "ord_status") <> "" Then
	...
	ls_order_status = dw_select.GetItemString(1, "ord_status")	
...
//		ls_Where = ls_Where + " and delivery_master.Ord_Status = '" + dw_select.GetItemString(1, "ord_status") + "'"
		...
		ls_where = ls_where + " and delivery_master.Ord_status = '" + ls_order_status + "'"
...
type dw_select from w_std_report`dw_select within w_powerwave_order_ship_status_report
event process_enter pbm_dwnprocessenter
integer x = 0
integer y = 0
integer width = 3419
integer height = 180
string dataobject = "d_powerwave_order_ship_status_search"
...
type cb_clear from w_std_report`cb_clear within w_powerwave_order_ship_status_report
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_powerwave_order_ship_status_report
integer x = 5
integer y = 204
integer width = 3429
integer height = 1656
integer taborder = 30
string dataobject = "d_powerwave_order_ship_status_rpt"
