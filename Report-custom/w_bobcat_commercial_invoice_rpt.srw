HA$PBExportHeader$w_bobcat_commercial_invoice_rpt.srw
$PBExportComments$Bobcat Commercial Invoice Report
forward
global type w_bobcat_commercial_invoice_rpt from w_std_report
end type
end forward
...
integer width = 3653
integer height = 2356
string title = "Bobcat Commercial Invoice"
end type
global w_bobcat_commercial_invoice_rpt w_bobcat_commercial_invoice_rpt
...
on w_bobcat_commercial_invoice_rpt.create
call super::create
end on

on w_bobcat_commercial_invoice_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_bobcat_commercial_invoice_rpt
...
type cb_clear from w_std_report`cb_clear within w_bobcat_commercial_invoice_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_bobcat_commercial_invoice_rpt
integer x = 32
integer y = 12
integer width = 3483
integer height = 2056
integer taborder = 30
string dataobject = "d_bobcat_commercial_invoice_rpt"
