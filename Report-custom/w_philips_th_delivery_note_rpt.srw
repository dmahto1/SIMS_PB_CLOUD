HA$PBExportHeader$w_philips_th_delivery_note_rpt.srw
$PBExportComments$Philips Singapore Delivery Note
forward
global type w_philips_th_delivery_note_rpt from w_std_report
end type
end forward
...
global w_philips_th_delivery_note_rpt w_philips_th_delivery_note_rpt
...
on w_philips_th_delivery_note_rpt.create
call super::create
end on

on w_philips_th_delivery_note_rpt.destroy
call super::destroy
...
If isVAlid(w_do) Then
	...
	dw_report.dataobject = 'd_philips_th_delivery_note'
...
ElseIf isVAlid(w_ro) Then /*Return Order*/
	...
	dw_report.dataobject = 'd_philips_th_return_note'
...
type dw_select from w_std_report`dw_select within w_philips_th_delivery_note_rpt
...
type cb_clear from w_std_report`cb_clear within w_philips_th_delivery_note_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_philips_th_delivery_note_rpt
integer x = 0
integer y = 12
integer width = 3483
integer height = 1908
