HA$PBExportHeader$w_phxbrands_short_shipped_rpt.srw
forward
global type w_phxbrands_short_shipped_rpt from w_std_report
end type
end forward
...
global w_phxbrands_short_shipped_rpt w_phxbrands_short_shipped_rpt
...
on w_phxbrands_short_shipped_rpt.create
call super::create
end on

on w_phxbrands_short_shipped_rpt.destroy
call super::destroy
...
//	END IF	
	...
	dw_report.SetRedraw(False)
	ll_cnt = dw_report.Retrieve( gs_project, ldt_s, ldt_e )
	IF ll_cnt > 0 Then
...
type dw_select from w_std_report`dw_select within w_phxbrands_short_shipped_rpt
event process_enter pbm_dwnprocessenter
integer width = 2871
integer height = 412
string dataobject = "d_phxbrands_short_shipped_rpt_search"
end type
...
type cb_clear from w_std_report`cb_clear within w_phxbrands_short_shipped_rpt
end type

type dw_report from w_std_report`dw_report within w_phxbrands_short_shipped_rpt
integer y = 476
string dataobject = "d_phxbrands_short_shipped_rpt"
