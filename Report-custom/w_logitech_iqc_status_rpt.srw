HA$PBExportHeader$w_logitech_iqc_status_rpt.srw
$PBExportComments$IAE Shipping Transaction Report
forward
global type w_logitech_iqc_status_rpt from w_std_report
end type
end forward
...
integer width = 3474
integer height = 2312
string title = "IQC Status Report"
end type
global w_logitech_iqc_status_rpt w_logitech_iqc_status_rpt
...
on w_logitech_iqc_status_rpt.create
call super::create
end on

on w_logitech_iqc_status_rpt.destroy
call super::destroy
...
//	ls_Where += " and Receive_Detail.sku = '" + dw_select.GetItemString(1,'invoice_no') + "'"
//End If
...
type dw_select from w_std_report`dw_select within w_logitech_iqc_status_rpt
integer x = 5
integer y = 16
integer width = 2985
integer height = 168
string dataobject = "d_logitech_iqc_status_rpt_select"
...
type cb_clear from w_std_report`cb_clear within w_logitech_iqc_status_rpt
integer width = 293
integer height = 96
end type

type dw_report from w_std_report`dw_report within w_logitech_iqc_status_rpt
integer x = 14
integer y = 196
integer width = 3392
integer height = 1900
string dataobject = "d_logitech_iqc_status_rpt"
