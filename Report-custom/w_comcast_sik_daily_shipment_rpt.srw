HA$PBExportHeader$w_comcast_sik_daily_shipment_rpt.srw
$PBExportComments$Comcast SIK Daily Shipment REport
forward
global type w_comcast_sik_daily_shipment_rpt from w_std_report
end type
end forward
...
integer width = 3566
integer height = 2100
string title = "Comcast SIK Daily Shipment Report"
event ue_load_philips_notes ( )
end type
global w_comcast_sik_daily_shipment_rpt w_comcast_sik_daily_shipment_rpt
...
on w_comcast_sik_daily_shipment_rpt.create
call super::create
end on

on w_comcast_sik_daily_shipment_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_comcast_sik_daily_shipment_rpt
...
type cb_clear from w_std_report`cb_clear within w_comcast_sik_daily_shipment_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_comcast_sik_daily_shipment_rpt
integer x = 32
integer y = 208
integer width = 3429
integer height = 1588
integer taborder = 30
string dataobject = "d_comcast_sik_shipment_rpt"
