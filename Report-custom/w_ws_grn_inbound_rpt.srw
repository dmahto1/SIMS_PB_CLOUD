HA$PBExportHeader$w_ws_grn_inbound_rpt.srw
forward
global type w_ws_grn_inbound_rpt from w_std_report
end type
end forward
...
global w_ws_grn_inbound_rpt w_ws_grn_inbound_rpt

on w_ws_grn_inbound_rpt.create
call super::create
end on

on w_ws_grn_inbound_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_ws_grn_inbound_rpt
boolean visible = false
integer x = 5
integer width = 41
integer height = 36
...
type cb_clear from w_std_report`cb_clear within w_ws_grn_inbound_rpt
integer x = 3035
integer y = 36
end type

type dw_report from w_std_report`dw_report within w_ws_grn_inbound_rpt
integer x = 0
integer y = 0
integer width = 5627
integer height = 1944
string dataobject = "d_ws_grn_inbound"
