HA$PBExportHeader$u_nvo_process_dn.sru
...
Choose Case Upper(gs_project)
	...
	Case 'PHILIPS-SG', 'PHILIPSCLS' ,'TPV', 'FUNAI', 'GIBSON' /*TAM 2015/03 - Added Gibson */
...
If idsMain.GetITEmString(1,'wh_Code') = 'PHILIPS-MY' or idsMain.GetITEmString(1,'wh_Code') = 'FUNAI-MY'  or idsMain.GetITEmString(1,'wh_Code') = 'GIBSON-MY'    Then /* 01/13 - PCONKL - added TPV*/ /* 6/13 - MEA - added FUNAI *//* TAM - 2015/03 - Added Gibson */
	...
	IF upper(gs_project) ='PHILIPSCLS' THEN ldsReport.modify( "t_14.text='Ultimate Consignee Information' ")
...
public function integer uf_process_batch_dn ();//1-FEB-2019 :Madhu S28945 Added PHILIPSCLS

Choose Case Upper(gs_project)
		
	Case 'PHILIPS-SG', 'PHILIPSCLS' ,'TPV', 'FUNAI', 'GIBSON' /*TAM - 2013/03 - Added Gibson */
