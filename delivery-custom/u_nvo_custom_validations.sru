HA$PBExportHeader$u_nvo_custom_validations.sru
...
//				search all completed orders  (delivery_Master.ord_status = C or D) for each SKU in the order being confirmed, check to see that the KAN BAN/SKU combination does not exist in any of them
	...
	Case 'PHILIPS-SG', 'PHILIPSCLS', 'TPV', 'FUNAI', 'GIBSON' /* 12/12 - PCONKl - added TPV */ /* 6/13 - added FUNAI */ /*TAM 2015/03 added GIBSON*/
		llRowCount = w_do.idw_Pack.RowCount()
...
//
//$$HEX2$$22200900$$ENDHEX$$At Ready to Ship (and Ship confirm): Packed OK (all lines in cartons)?
//$$HEX2$$22200900$$ENDHEX$$At UCC-128 label Print: Rdy to ship done? 
//$$HEX2$$22200900$$ENDHEX$$At Ship confirm: UCC-128 Labels printed? ( or at least web app launched) 
//
//Could the indicator be overloaded in the UF for UCC-128? I think the current value is $$HEX1$$1c20$$ENDHEX$$LBL$$HEX1$$1d20$$ENDHEX$$, maybe we could make it $$HEX1$$1c20$$ENDHEX$$LBLP$$HEX2$$1d202000$$ENDHEX$$when they attempt to print it. All other logic could check for non-blank or both values.
//
