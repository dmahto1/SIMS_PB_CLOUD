HA$PBExportHeader$u_nvo_custom_packlists.sru
...
//	If lsNotify = '' Then
//		lsNotify = "CHECK FOR $$HEX1$$1820$$ENDHEX$$SHIPPING INSTRUCTIONS"
//	End If
...
If isnull(w_do.idw_main.getitemdatetime(1,"freight_etd")) or isnull(w_do.idw_main.getitemdatetime(1,"freight_eta")) Then
	Messagebox(w_do.is_title,"Freight ETD (Fecha de Env$$HEX1$$ed00$$ENDHEX$$o) and Freight ETA (Fecha Estimada de Llegada)~rmust be entered before printing the Packing List and Pallet Labels.",Stopsign!)
...
long ll_detail_FindRow,ll_Serial_count,llSerialPos,ll_Find_row
long llScannedQty, lleligiblecnt
...
presentation_str = "style(type=grid)"
lsSQL = "Select Line_Item_No, SKU, Delivery_Serial_Detail.Serial_No as 'serial_no',  Delivery_Serial_Detail.Carton_No from Delivery_Picking_Detail, Delivery_Serial_Detail "
lsSQL += " Where Delivery_Picking_Detail.do_no = '" + ls_dono + "' and delivery_Picking_Detail.id_no = Delivery_Serial_Detail.ID_NO "
...
//	
	...
	ls_Find_serial =  " sku = '" + ls_sku +  "' and Line_Item_No = " + String(ll_LineItemNo) + ""
