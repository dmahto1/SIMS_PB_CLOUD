HA$PBExportHeader$w_do_copy_packlist.srw
$PBExportComments$Parms for PackList Copy Row function
forward
global type w_do_copy_packlist from w_response_ancestor
end type
type st_1 from statictext within w_do_copy_packlist
end type
type st_2 from statictext within w_do_copy_packlist
end type
type sle_rows from singlelineedit within w_do_copy_packlist
end type
type sle_qty from singlelineedit within w_do_copy_packlist
end type
type st_3 from statictext within w_do_copy_packlist
end type
type st_4 from statictext within w_do_copy_packlist
end type
end forward
...
integer width = 1193
integer height = 632
string title = "Copy PackList Row"
st_1 st_1
st_2 st_2
sle_rows sle_rows
sle_qty sle_qty
...
global w_do_copy_packlist w_do_copy_packlist

on w_do_copy_packlist.create
int iCurrent
call super::create
...
//29-Nov-2018 :Madhu DE7438 - Don't Allow Decimal Qty's
...
//29-Nov-2018 :Madhu DE7438 - Don't Allow Decimal Qty's
IF g.iballowquantitydecimals =FALSE and MATCH(sle_qty.Text, "^[0-9]*[\.\+][0-9]*$") THEN
	MessageBox("Copy Row","Decimal Quantities are not allowed!", StopSign!)
	sle_qty.SetFocus()
	sle_qty.SelectText(1,Len(sle_qty.Text))
	Return 1
END IF
...
type cb_cancel from w_response_ancestor`cb_cancel within w_do_copy_packlist
integer x = 649
integer y = 420
integer width = 242
integer height = 92
...
type cb_ok from w_response_ancestor`cb_ok within w_do_copy_packlist
integer x = 274
integer y = 420
integer width = 242
integer height = 92
