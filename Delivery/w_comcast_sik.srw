HA$PBExportHeader$w_comcast_sik.srw
forward
...
If ll_row > 0 Then
	...
	End If
	//Jxlim 11/13/2010 
	//After printed the welcome letter, Set Delivery_Master.User_Field2 to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$.
...
for i = 1 to ll_cnt 
	...
	//After printed the account card, Set Delivery_Master.User_Field2 to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$.
	dw_main.SetItem(1, 'user_field2', 'Y')
