HA$PBExportHeader$w_maintenance_uom.srw
$PBExportComments$BCR - UOM Maintenance window
forward
global type w_maintenance_uom from w_std_simple_list
end type
end forward
...
integer width = 2793
integer height = 1648
string title = "UOM List"
end type
global w_maintenance_uom w_maintenance_uom

type variables
w_maintenance_uom iw_window

end variables

on w_maintenance_uom.create
call super::create
end on

on w_maintenance_uom.destroy
call super::destroy
...
IF isnull(ls_ctype) THEN dw_list.Setitem(dw_list.Getrow(),'code_type','IMUOM')
...
type dw_list from w_std_simple_list`dw_list within w_maintenance_uom
integer x = 37
integer y = 32
integer width = 2688
string dataobject = "d_maintenance_uom"
