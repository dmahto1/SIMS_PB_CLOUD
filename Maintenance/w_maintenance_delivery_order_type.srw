HA$PBExportHeader$w_maintenance_delivery_order_type.srw
$PBExportComments$-
forward
global type w_maintenance_delivery_order_type from w_std_simple_list
end type
end forward
...
integer width = 2615
integer height = 1644
string title = "Delivery Oder Type List"
end type
global w_maintenance_delivery_order_type w_maintenance_delivery_order_type

type variables
w_maintenance_delivery_order_type iw_window

end variables

on w_maintenance_delivery_order_type.create
call super::create
end on

on w_maintenance_delivery_order_type.destroy
call super::destroy
...
// 12/03 - PCONKL - only show CCC checkbox if enabled for project
//If not g.ibCCCEnabled Then
//	dw_list.Modify("ccc_enabled_ind.visible=false ccc_enabled_t.visible=false")
//End If
...
type dw_list from w_std_simple_list`dw_list within w_maintenance_delivery_order_type
integer y = 32
integer width = 2505
string dataobject = "d_delivery_order_type"
end type
