HA$PBExportHeader$w_maintenance_transport_mode.srw
$PBExportComments$- Maintain Transport Mode Types
forward
global type w_maintenance_transport_mode from w_std_simple_list
end type
end forward
...
global w_maintenance_transport_mode w_maintenance_transport_mode

on w_maintenance_transport_mode.create
call super::create
end on

on w_maintenance_transport_mode.destroy
call super::destroy
...
IF isnull(ls_ctype) THEN dw_list.Setitem(dw_list.Getrow(),'code_type','TRNMD')
...
// 08/00 PCONKL - Filter for current Project
...
type dw_list from w_std_simple_list`dw_list within w_maintenance_transport_mode
integer width = 2240
string dataobject = "d_transport_mode_type"
end type
