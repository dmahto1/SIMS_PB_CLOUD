HA$PBExportHeader$w_maintenance_customer_type.srw
$PBExportComments$- customer modify
forward
global type w_maintenance_customer_type from w_std_simple_list
end type
end forward

global type w_maintenance_customer_type from w_std_simple_list
integer width = 2702
string title = "Customer Type List"
end type
global w_maintenance_customer_type w_maintenance_customer_type

on w_maintenance_customer_type.create
call super::create
end on

on w_maintenance_customer_type.destroy
call super::destroy
...
IF isnull(ls_ctype) THEN dw_list.Setitem(dw_list.Getrow(),'code_type','CTYPE')
...
type dw_list from w_std_simple_list`dw_list within w_maintenance_customer_type
integer width = 2240
string dataobject = "d_customer_type"
end type
