HA$PBExportHeader$w_maintenance_itemmaster.srw
...
//In ue_PostOpen, create $$HEX1$$1c20$$ENDHEX$$n_otm$$HEX2$$1d202000$$ENDHEX$$as an instance variable if g.is_OTM_Item_Master_Send_Ind is set to $$HEX1$$1820$$ENDHEX$$Y$$HEX1$$1920$$ENDHEX$$. 
...
//Wine and Spirit is actually going to be multiple projects but all project will start with$$HEX1$$1d20$$ENDHEX$$WS-$$HEX3$$1c2020002000$$ENDHEX$$
