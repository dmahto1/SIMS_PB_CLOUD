HA$PBExportHeader$w_maintenance_workorder_type.srw
$PBExportComments$- Maintain WorkORder Type Code Types
forward
global type w_maintenance_workorder_type from w_std_simple_list
end type
end forward

global type w_maintenance_workorder_type from w_std_simple_list
integer width = 2359
string title = "Work Order Types"
end type
global w_maintenance_workorder_type w_maintenance_workorder_type

on w_maintenance_workorder_type.create
call super::create
end on

on w_maintenance_workorder_type.destroy
call super::destroy
...
IF isnull(ls_ctype) THEN dw_list.Setitem(dw_list.Getrow(),'code_type','WOTYP')
...
type dw_list from w_std_simple_list`dw_list within w_maintenance_workorder_type
integer width = 2240
string dataobject = "d_workorder_code_type"
end type
