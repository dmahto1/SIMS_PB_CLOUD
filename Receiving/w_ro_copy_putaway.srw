HA$PBExportHeader$w_ro_copy_putaway.srw
$PBExportComments$Parms for Receive Putaway Copy Row function
forward
global type w_ro_copy_putaway from w_response_ancestor
end type
type st_1 from statictext within w_ro_copy_putaway
end type
type st_2 from statictext within w_ro_copy_putaway
end type
type sle_rows from singlelineedit within w_ro_copy_putaway
end type
type sle_qty from singlelineedit within w_ro_copy_putaway
end type
type st_3 from statictext within w_ro_copy_putaway
end type
type st_4 from statictext within w_ro_copy_putaway
end type
end forward
...
global w_ro_copy_putaway w_ro_copy_putaway

on w_ro_copy_putaway.create
int iCurrent
call super::create
...
//SARUN22DEC16 : Checking if Project Allow Decimal inventory or no
...
If   pos(sle_qty.Text,'.') > 0  and g.iballowquantitydecimals  = FALSE  then
	messagebox('Copy Row','Decimal Not allowed!',StopSign!)
	sle_qty.SetFocus()
	sle_qty.SelectText(1,Len(sle_qty.Text))
	REturn 1
End If
...
type cb_cancel from w_response_ancestor`cb_cancel within w_ro_copy_putaway
integer x = 649
integer y = 420
integer width = 242
integer height = 92
...
type cb_ok from w_response_ancestor`cb_ok within w_ro_copy_putaway
integer x = 274
integer y = 420
integer width = 242
integer height = 92
