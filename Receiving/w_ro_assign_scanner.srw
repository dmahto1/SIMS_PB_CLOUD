HA$PBExportHeader$w_ro_assign_scanner.srw
$PBExportComments$- Assign Scanner ID to Orders
forward
global type w_ro_assign_scanner from w_main_ancestor
end type
type st_1 from statictext within w_ro_assign_scanner
end type
type dw_assign_scanner from datawindow within w_ro_assign_scanner
end type
type ddlb_scanner_id from dropdownlistbox within w_ro_assign_scanner
end type
type cb_selectall from commandbutton within w_ro_assign_scanner
end type
type cb_clear from commandbutton within w_ro_assign_scanner
end type
type cb_assign from commandbutton within w_ro_assign_scanner
end type
end forward
...
integer width = 3259
integer height = 1720
string title = "Assign Scanner ID to Recieving Orders"
event ue_selectall ( )
event ue_clear ( )
event ue_apply ( )
...
global w_ro_assign_scanner w_ro_assign_scanner
...
on w_ro_assign_scanner.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_ro_assign_scanner
integer x = 2907
integer y = 1432
integer height = 84
integer taborder = 50
...
type cb_ok from w_main_ancestor`cb_ok within w_ro_assign_scanner
integer x = 2528
integer y = 1432
integer height = 84
integer taborder = 40
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_ro_assign_scanner"
