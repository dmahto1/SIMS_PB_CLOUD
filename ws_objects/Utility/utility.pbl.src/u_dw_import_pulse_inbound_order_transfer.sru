$PBExportHeader$u_dw_import_pulse_inbound_order_transfer.sru
...
//Add “Container ID” column which will be displayed under Putaway screen.  
//Add 3 columns for “Length”, “Width” and “Height” which will be displayed under Putaway screen
//During inbound order import, allow to overwrite the “Container ID” and “IMI #” (Lot_no) algorithm when order types are “I” (Item Transfer to Liaobu) and “T” (Trail Shipment to Liaobu) 
// 
