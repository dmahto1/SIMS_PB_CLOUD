$PBExportHeader$w_powerwave_huawei_part_labels_orig.srw
$PBExportComments$Powerwave huawei Part Label
forward
global type w_powerwave_huawei_part_labels_orig from w_main_ancestor
end type
type cb_print from commandbutton within w_powerwave_huawei_part_labels_orig
end type
type dw_label from u_dw_ancestor within w_powerwave_huawei_part_labels_orig
end type
type cb_selectall from commandbutton within w_powerwave_huawei_part_labels_orig
end type
type cb_clear from commandbutton within w_powerwave_huawei_part_labels_orig
end type
end forward
...
global w_powerwave_huawei_part_labels_orig w_powerwave_huawei_part_labels_orig
...
on w_powerwave_huawei_part_labels_orig.create
int iCurrent
call super::create
...
on w_powerwave_huawei_part_labels_orig.destroy
call super::destroy
...
type cb_cancel from w_main_ancestor`cb_cancel within w_powerwave_huawei_part_labels_orig
...
type cb_ok from w_main_ancestor`cb_ok within w_powerwave_huawei_part_labels_orig
integer x = 1769
integer y = 32
integer height = 80
integer textsize = -9
