$PBExportHeader$w_klonelab_part_label.srw
forward
...
//o	Line Item
//o	SKU
//-	Dropdown to select label format to print (I don’t believe we will have a customer master or Order field to get the format from – they will need to manually choose )
//
