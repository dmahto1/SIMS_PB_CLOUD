$PBExportHeader$u_dw_import_update_nike_order.sru
...
public function integer wf_save ();//
////Upon validation pass ,  for each SHP (order no) update the corresponding fields in SIMS with those data found in the excel file –Batch No (LOB) , Region, Carton Remarks and Remarks.
...
//
//
////–Batch No (LOB) , Region, Carton Remarks and Remarks.
//
