...
ls_weight = String(lstrparms.Decimal_Arg[1],'#######.##') + "/" + String(lstrparms.Decimal_Arg[2],'#######.##') // Dinesh - 04/07/2025- SIMS-646- Development for Google - SIMS -Weight in Packing list not matching on Shipping Label 
