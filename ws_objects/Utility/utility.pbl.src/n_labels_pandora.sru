...
lsFormat = uf_Replace(lsFormat,"~~Client_Cust_Po_Nbr~~",Left(lstrparms.String_Arg[22],20)) //Vendor Order Nbr
lsFormat = uf_Replace(lsFormat,"~~Ship_Date~~",string(today(),"mmm dd, yyyy")) //Ship Date (//Today's date )
//ls_weight = String(lstrparms.Long_Arg[5]) + "/" + String(lstrparms.Long_Arg[6]) // Dinesh - 04/07/2025- SIMS-646- Development for Google - SIMS -Weight in Packing list not matching on Shipping Label 
ls_weight = String(lstrparms.Decimal_Arg[1],'#######.##') + "/" + String(lstrparms.Decimal_Arg[2],'#######.##') // Dinesh - 04/07/2025- SIMS-688- Development for Google - SIMS - Shipping Label 
//ls_weight = String(lstrparms.Long_Arg[5]) + " Lbs" + "/" + String(lstrparms.Long_Arg[6]) + " Kgs" /// Dinesh - 03/20/2025- SIMS-688- Development for Google - SIMS - Shipping Label
lsFormat = uf_Replace(lsFormat,"~~Weight~~",ls_weight )
//lsFormat = uf_Replace(lsFormat,"~~Weight_lbs_no~~",String(lstrparms.Long_Arg[5]))// Dinesh - 04/07/2025- SIMS-646- Development for Google - SIMS -Weight in Packing list not matching on Shipping Label 
