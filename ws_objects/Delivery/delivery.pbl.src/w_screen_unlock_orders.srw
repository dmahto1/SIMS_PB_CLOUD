$PBExportHeader$w_screen_unlock_orders.srw
$PBExportComments$+Delivery Order
forward
global type w_screen_unlock_orders from w_response_ancestor
end type
type sle_new_text from singlelineedit within w_screen_unlock_orders
end type
type dw_avail from u_dw_ancestor within w_screen_unlock_orders
end type
type dw_selected from u_dw_ancestor within w_screen_unlock_orders
end type
type cb_add from commandbutton within w_screen_unlock_orders
end type
type cb_delete from commandbutton within w_screen_unlock_orders
end type
type st_selected_users from statictext within w_screen_unlock_orders
end type
type cb_delete_avail from commandbutton within w_screen_unlock_orders
end type
type pb_clear_all from picturebutton within w_screen_unlock_orders
end type
type st_unlock_user from statictext within w_screen_unlock_orders
end type
type cb_search from commandbutton within w_screen_unlock_orders
end type
type st_user from statictext within w_screen_unlock_orders
end type
type cb_1 from commandbutton within w_screen_unlock_orders
end type
type gb_options from groupbox within w_screen_unlock_orders
end type
end forward
...
on w_screen_unlock_orders.destroy
call super::destroy
...
type cb_cancel from w_response_ancestor`cb_cancel within w_screen_unlock_orders
integer x = 2158
integer y = 1448
end type
...
type cb_ok from w_response_ancestor`cb_ok within w_screen_unlock_orders
integer x = 1824
integer y = 1448
...
string dataobject = "d_screen_locked_user_list"
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_screen_unlock_select"
boolean hscrollbar = true
boolean vscrollbar = true
end type
...
string text = "Selected Orders and Users to unlock"
...
long textcolor = 8388608
long backcolor = 67108864
string text = "List of locked orders for the Users"
boolean focusrectangle = false
end type
