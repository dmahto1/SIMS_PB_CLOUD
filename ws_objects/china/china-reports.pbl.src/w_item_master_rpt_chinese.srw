$PBExportHeader$w_item_master_rpt_chinese.srw
$PBExportComments$Window used for displaying Item Master replenishment information
forward
global type w_item_master_rpt_chinese from w_std_report
end type
end forward
...
global w_item_master_rpt_chinese w_item_master_rpt_chinese
...
on w_item_master_rpt_chinese.create
call super::create
end on

on w_item_master_rpt_chinese.destroy
call super::destroy
...
//Dinesh - 11/19/2020- S51443- PhilipsDA
...
type dw_select from w_std_report`dw_select within w_item_master_rpt_chinese
integer x = 9
integer y = 0
integer width = 3470
integer height = 200
...
type cb_clear from w_std_report`cb_clear within w_item_master_rpt_chinese
integer x = 2880
integer y = 4
end type

type dw_report from w_std_report`dw_report within w_item_master_rpt_chinese
integer x = 23
integer y = 240
integer width = 3570
integer height = 1712
string dataobject = "d_item_master_rpt_chinese"
