$PBExportHeader$w_delivery_by_sku_rpt_chinese.srw
...
If date(dw_select.GetItemDateTime(1,"from_date")) > date('01-01-1900') Then
	...
	lsReportHeader += "开始时间: " + string(dw_select.GetItemDateTime(1,"from_date"),'mm/dd/yyyy')
...
If date(dw_select.GetItemDateTime(1,"To_date")) > date('01-01-1900') Then
	...
	lsReportHeader += " 结束时间: " + string(dw_select.GetItemDateTime(1,"To_date"),'mm/dd/yyyy')
End If
