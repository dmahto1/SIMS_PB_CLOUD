$PBExportHeader$w_stock_movement_rpt_by_date_chinese.srw
...
dw_report.Object.t_date_range.text = String(ldt_s,'mm/dd/yyyy hh:mm') + ' 到 ' + String(ldt_e,'mm/dd/yyyy hh:mm')
