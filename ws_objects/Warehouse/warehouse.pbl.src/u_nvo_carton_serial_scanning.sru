$PBExportHeader$u_nvo_carton_serial_scanning.sru
...
//GailM 10/28/2019 DE13105 Google - Outbound - If user assigns only a container ID for GPNs, the serial tab won’t scan the Container ID
