$PBExportHeader$w_starbucks-th_po.srw
$PBExportComments$Starbucks TH PO
forward
global type w_starbucks-th_po from w_std_report
end type
end forward
...
global w_starbucks-th_po w_starbucks-th_po
...
on w_starbucks-th_po.create
call super::create
end on

on w_starbucks-th_po.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_starbucks-th_po
boolean visible = false
integer x = 18
integer width = 3131
boolean enabled = false
string dataobject = "d_damaris_inv_search"
...
type cb_clear from w_std_report`cb_clear within w_starbucks-th_po
integer x = 3154
integer y = 12
integer width = 270
end type
...
type dw_report from w_std_report`dw_report within w_starbucks-th_po
integer x = 18
integer y = 32
integer width = 3401
integer height = 1704
string dataobject = "d-starbucks-th_po"
