$PBExportHeader$w_starbucks-th_dn.srw
$PBExportComments$Starbucks consolidated DN
forward
global type w_starbucks-th_dn from w_std_report
end type
type cb_1 from commandbutton within w_starbucks-th_dn
end type
end forward
...
integer width = 3566
integer height = 2100
string title = "Starbucks Consolidated Delivery Note"
cb_1 cb_1
end type
global w_starbucks-th_dn w_starbucks-th_dn
...
// Tackon 'Where' before 'Group By'
llPos = Pos(lsOrigSql,'Group')
...
type dw_select from w_std_report`dw_select within w_starbucks-th_dn
...
type cb_clear from w_std_report`cb_clear within w_starbucks-th_dn
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_starbucks-th_dn
integer x = 5
integer y = 296
integer width = 3419
integer height = 1448
...
string dataobject = "d_starbucks-th-delivery_note_consol"
boolean minbox = true
