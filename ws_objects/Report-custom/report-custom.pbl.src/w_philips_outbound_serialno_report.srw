$PBExportHeader$w_philips_outbound_serialno_report.srw
$PBExportComments$OutBound Order Report (GAP - 8/02)
forward
global type w_philips_outbound_serialno_report from w_std_report
end type
type uo_order_status_search from uo_multi_select_search within w_philips_outbound_serialno_report
end type
end forward
...
integer width = 3566
integer height = 2100
string title = "Outbound Serial No. Report"
event ue_load_philips_notes ( )
uo_order_status_search uo_order_status_search
end type
global w_philips_outbound_serialno_report w_philips_outbound_serialno_report
...
on w_philips_outbound_serialno_report.create
int iCurrent
call super::create
...
on w_philips_outbound_serialno_report.destroy
call super::destroy
...
If gs_project = 'PHILIPS-SG' or gs_project ='PHILIPSCLS' or gs_project = 'TPV'  or gs_project = 'FUNAI'  or gs_project = 'GIBSON' or gs_project ='PHILIPS-DA' Then /*TAM 2015/03 - Added Gibson */
...
type dw_select from w_std_report`dw_select within w_philips_outbound_serialno_report
event process_enter pbm_dwnprocessenter
integer x = 0
integer y = 0
integer width = 3419
integer height = 464
string dataobject = "d_philips_outbound_serialno_search"
...
type cb_clear from w_std_report`cb_clear within w_philips_outbound_serialno_report
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_philips_outbound_serialno_report
integer x = 5
integer y = 460
integer width = 3429
integer height = 1400
integer taborder = 30
string dataobject = "d_philips_outbound_serialno_report"
