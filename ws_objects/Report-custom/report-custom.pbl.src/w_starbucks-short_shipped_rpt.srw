$PBExportHeader$w_starbucks-short_shipped_rpt.srw
$PBExportComments$Starbucks consolidated DN
forward
global type w_starbucks-short_shipped_rpt from w_std_report
end type
type cb_1 from commandbutton within w_starbucks-short_shipped_rpt
end type
end forward
...
global w_starbucks-short_shipped_rpt w_starbucks-short_shipped_rpt
...
on w_starbucks-short_shipped_rpt.create
int iCurrent
call super::create
...
on w_starbucks-short_shipped_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_starbucks-short_shipped_rpt
event process_enter pbm_dwnprocessenter
integer x = 0
integer y = 0
integer width = 3419
integer height = 288
string dataobject = "d_starbucks-th_dn_search"
...
type cb_clear from w_std_report`cb_clear within w_starbucks-short_shipped_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_starbucks-short_shipped_rpt
integer x = 5
integer y = 296
integer width = 5143
integer height = 1448
...
string dataobject = "d_starbucks-short_shipped_rpt"
boolean minbox = true
