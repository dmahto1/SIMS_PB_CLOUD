$PBExportHeader$u_nvo_proc_powerwave.sru
...
//·	Append! - (Default) Write data to the end of the file·	Replace! - Replace all existing data in the fileWritemode is ignored if the fileaccess argument is Read!
