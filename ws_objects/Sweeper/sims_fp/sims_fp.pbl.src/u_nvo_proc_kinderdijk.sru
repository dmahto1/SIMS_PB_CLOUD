$PBExportHeader$u_nvo_proc_kinderdijk.sru
...
//The File name can be ItemQtyYYYYMMDDHHSS.csv (prefix with ‘ItemQty’)
//Note: the ‘LOCTNID’ field should be handled by SIMS as an ‘Inventory Type’ handling. 
