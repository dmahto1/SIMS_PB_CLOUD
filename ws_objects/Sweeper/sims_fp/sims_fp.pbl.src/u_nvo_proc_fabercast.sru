$PBExportHeader$u_nvo_proc_fabercast.sru
forward
global type u_nvo_proc_fabercast from nonvisualobject
end type
end forward

global type u_nvo_proc_fabercast from nonvisualobject
end type
global u_nvo_proc_fabercast u_nvo_proc_fabercast
...
on u_nvo_proc_fabercast.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_nvo_proc_fabercast.destroy
