...
//		end if
	...
	Case 'PHILIPS-DA' //dts - 11/19/2020 - S51577
...
Choose Case Upper(asproject)
	...
	//Begin Dinesh - 11/10/2020 - S51259 -  Product Picked (SIMS)
	Case 'PHILIPS-DA' 
	...
	//End Dinesh - 11/10/2020 - S51259 -  Product Picked (SIMS)
...
asProject = trim(asProject)
asOrderId = trim(asOrderId)
...
//TAM - 2019/01/30 - S28686 - Added PHILIPSCLS	
	...
	Case 'PHILIPS-DA' // Dinesh - S50900 - Philips DA - 11/5/2020 
...
//		end if
	...
	//dts - 11/18/2020 - S51540 - use PHILIPSCLS code for PHILIPS-DA
	Case 'PHILIPS-DA'
...
CHOOSE CASE upper(asproject)
	...
	CASE 'PHILIPSCLS', 'PHILIPS-DA' // Dinesh - 07/23/21- DE22413-GR/ RT files not generated for PHILIPS-DA
		IF not IsValid(iu_nvo_philipscls) THEN 
			iu_nvo_philipscls = create u_nvo_edi_confirmations_philipscls
		END IF
