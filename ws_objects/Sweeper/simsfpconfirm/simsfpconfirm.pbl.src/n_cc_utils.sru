...
if NOT IsNull( ads_si ) and ads_si.RowCount() > 0 then
	...
	for k = 1 to 3
		...
		//MikeA - 04/28/2020 - DE15701 - SIMS - Google - Cycle Cout upcount error
		//We never know if ads_si and ll_rows will be the same if skus are added or deleted.  

		if ll_rows > 0  then  //and ads_si.RowCount() <> ll_rows
