$PBExportHeader$u_nvo_edi_confirmations_physio_maa.sru
...
CHOOSE CASE ls_language
	CASE 'SPANISH'
		ls_email_string +="Por favor, no contesten a este correo electrónico ya que se trata de un respuesta automática. ~n"
	CASE 'ITALIAN'
		ls_email_string +="Si prega cortesemente di non rispondere alla presente email poichè generata automaticamente. ~n"
	CASE 'BELGIUM'
		ls_email_string +="Veuillez prendre note qu’il pourrait y avoir un délai avant que le numéro de suivi soit visible sur le site du transporteur. ~n"+&
		...
		"Merci de ne pas répondre à ce mail généré automatiquement. ~n"+&
	...
	CASE "SWITZERLAND"
		...
		"Vi informiamo che il numero di spedizione sarà consultabile sul sito del corriere. Precisiamo che non sarà visibile nell’immediato ma secondo i tempi di elaborazione del sistema di ciascun corriere. ~n~n"+&
		"Merci de ne pas répondre à ce mail généré automatiquement. ~n"+&
		"Bitte antworten sie nicht auf diese Email, da dies eine automatisierte Nachricht ist. ~n"+&
		"Si prega cortesemente di non rispondere alla presente email poichè generata automaticamente. ~n"
END CHOOSE
