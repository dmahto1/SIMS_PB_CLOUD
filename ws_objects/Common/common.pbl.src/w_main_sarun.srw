$PBExportHeader$w_main_sarun.srw
$PBExportComments$MDI Window
forward
global type w_main_sarun from window
end type
type mdi_1 from mdiclient within w_main_sarun
end type
end forward
...
global w_main_sarun w_main_sarun
...
on w_main_sarun.create
if this.MenuName = "m_main" then this.MenuID = create m_main
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_main_sarun.destroy
...
event resize;if isvalid (w_sims_banner) then w_sims_banner.postEvent ('ue_resize') //sarun
end event
