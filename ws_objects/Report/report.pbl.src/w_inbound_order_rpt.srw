$PBExportHeader$w_inbound_order_rpt.srw
$PBExportComments$This is the Inbound Order report
forward
global type w_inbound_order_rpt from w_std_report
end type
end forward
...
global w_inbound_order_rpt w_inbound_order_rpt
...
public subroutine setdropdowns ();DatawindowChild	ldwc_order_type
...
// LTK 20150827  Populate warehouse DDDW via common method which uses user's configured warehouses
...
on w_inbound_order_rpt.create
call super::create
end on

on w_inbound_order_rpt.destroy
call super::destroy
...
// LTK 20150827 custom for Pandora
If gs_project = 'PANDORA' Then
	dw_report.dataobject = 'd_inbound_order_rpt_pandora'
	dw_report.SetTransObject(SQLCA)
End If
...
type dw_select from w_std_report`dw_select within w_inbound_order_rpt
integer x = 0
integer width = 3575
integer height = 316
...
// LTK 20150827  Commented out block below, warehouses set in setDropDowns() and now calling common method
//
...
type cb_clear from w_std_report`cb_clear within w_inbound_order_rpt
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_inbound_order_rpt
integer x = 0
integer y = 332
integer width = 3419
integer height = 1544
integer taborder = 30
string dataobject = "d_inbound_order_rpt"
