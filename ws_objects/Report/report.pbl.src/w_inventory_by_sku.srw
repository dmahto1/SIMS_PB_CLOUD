$PBExportHeader$w_inventory_by_sku.srw
$PBExportComments$Window used for processing Inventory by SKU information
forward
global type w_inventory_by_sku from w_std_report
end type
end forward
...
global w_inventory_by_sku w_inventory_by_sku
...
on w_inventory_by_sku.create
call super::create
end on

on w_inventory_by_sku.destroy
call super::destroy
...
ElseIf left(gs_project,3) = 'WS-' Then
	...
	dw_report.SetTransObject(SQLCA)
ElseIf gs_project = 'SG-MUSER' Then
	dw_report.dataobject = 'd_inventory_by_sku_muser'
	dw_report.SetTransObject(SQLCA)
	// Dinesh - 19/11/2020- S51443- PHILIPS-DA - Mimic PHILIPSCLS logic in Reports
ElseIf (gs_project) = 'PHILIPSCLS'  OR (gs_project) = 'PHILIPS-DA' Then                              //NOV - 2019 - MikeaA - DE13517 - Only PHILIPSCLS
		dw_report.dataobject = 'd_inventory_by_sku_philips' //OCT - 2019 - MikeaA - S36898 - F17989 - Add Batch Code
	dw_report.SetTransObject(SQLCA)
End If
...
type dw_select from w_std_report`dw_select within w_inventory_by_sku
integer x = 0
integer width = 3227
integer height = 188
...
type cb_clear from w_std_report`cb_clear within w_inventory_by_sku
integer x = 3365
integer y = 12
integer width = 96
integer taborder = 20
...
type dw_report from w_std_report`dw_report within w_inventory_by_sku
integer x = 5
integer y = 204
integer width = 3438
integer height = 1716
