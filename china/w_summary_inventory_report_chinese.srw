HA$PBExportHeader$w_summary_inventory_report_chinese.srw
$PBExportComments$Window used for displaying summary inventory information
forward
global type w_summary_inventory_report_chinese from w_std_report
end type
end forward
...
global w_summary_inventory_report_chinese w_summary_inventory_report_chinese
...
on w_summary_inventory_report_chinese.create
call super::create
end on

on w_summary_inventory_report_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_summary_inventory_report_chinese
integer x = 23
integer y = 24
integer width = 3328
integer height = 188
...
type cb_clear from w_std_report`cb_clear within w_summary_inventory_report_chinese
integer x = 3104
integer y = 12
end type

type dw_report from w_std_report`dw_report within w_summary_inventory_report_chinese
integer x = 23
integer y = 208
integer width = 3543
integer height = 1560
string dataobject = "d_summary_inventory_rpt_chinese"
