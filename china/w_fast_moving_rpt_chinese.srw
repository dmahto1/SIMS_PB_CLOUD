HA$PBExportHeader$w_fast_moving_rpt_chinese.srw
$PBExportComments$Fast Moving Report
forward
global type w_fast_moving_rpt_chinese from w_std_report
end type
end forward
...
global w_fast_moving_rpt_chinese w_fast_moving_rpt_chinese
...
on w_fast_moving_rpt_chinese.create
call super::create
end on

on w_fast_moving_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_fast_moving_rpt_chinese
integer x = 0
integer y = 0
integer width = 3310
integer height = 224
...
type cb_clear from w_std_report`cb_clear within w_fast_moving_rpt_chinese
end type

type dw_report from w_std_report`dw_report within w_fast_moving_rpt_chinese
integer x = 9
integer y = 224
integer width = 3401
integer height = 1544
integer taborder = 30
string dataobject = "d_fast_moving_rpt_chinese"
