HA$PBExportHeader$w_inventory_by_type_chinese.srw
$PBExportComments$Window used for processing Inventory by SKU information
forward
global type w_inventory_by_type_chinese from w_std_report
end type
end forward
...
global w_inventory_by_type_chinese w_inventory_by_type_chinese
...
on w_inventory_by_type_chinese.create
call super::create
end on

on w_inventory_by_type_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_inventory_by_type_chinese
integer x = 0
integer width = 3227
integer height = 116
...
type cb_clear from w_std_report`cb_clear within w_inventory_by_type_chinese
integer x = 3365
integer y = 8
integer width = 96
integer taborder = 20
...
type dw_report from w_std_report`dw_report within w_inventory_by_type_chinese
integer x = 23
integer y = 124
integer width = 3438
integer height = 1796
integer taborder = 30
string dataobject = "d_inventory_type_chinese"
