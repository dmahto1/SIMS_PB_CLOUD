HA$PBExportHeader$w_completed_order_sku_shipped_report_chinese.srw
$PBExportComments$Allocation Report
forward
global type w_completed_order_sku_shipped_report_chinese from w_std_report
end type
end forward
...
global w_completed_order_sku_shipped_report_chinese w_completed_order_sku_shipped_report_chinese
...
on w_completed_order_sku_shipped_report_chinese.create
call super::create
end on

on w_completed_order_sku_shipped_report_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_completed_order_sku_shipped_report_chinese
integer x = 18
integer y = 0
integer width = 3351
integer height = 364
...
type cb_clear from w_std_report`cb_clear within w_completed_order_sku_shipped_report_chinese
integer x = 3154
integer y = 20
integer width = 55
integer height = 64
...
type dw_report from w_std_report`dw_report within w_completed_order_sku_shipped_report_chinese
integer x = 0
integer y = 376
integer width = 3625
integer height = 1516
integer taborder = 30
string dataobject = "d_completed_order_sku_shipped_report_chinese"
