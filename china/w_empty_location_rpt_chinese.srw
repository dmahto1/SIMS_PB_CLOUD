HA$PBExportHeader$w_empty_location_rpt_chinese.srw
$PBExportComments$Window used for processing the empty location report
forward
global type w_empty_location_rpt_chinese from w_std_report
end type
end forward
...
global w_empty_location_rpt_chinese w_empty_location_rpt_chinese
...
if li_show_allocated = 1  then
	...
	dw_report.DataObject = 'd_empty_location_rpt_show_alloc_chinese'
	...
	dw_report.DataObject = 'd_empty_location_rpt_not_show_alloc_chinese'
	dw_report.SetTransObject(SQLCA)
	dw_report.Object.show_allocated.Expression = string(li_show_allocated)	
end if
...
//we will want to populate the $$HEX1$$1c20$$ENDHEX$$pick_qty$$HEX2$$1d202000$$ENDHEX$$and $$HEX1$$1c20$$ENDHEX$$pack_qty$$HEX2$$19202000$$ENDHEX$$fields only if the $$HEX1$$1c20$$ENDHEX$$Show Allocated$$HEX2$$1d202000$$ENDHEX$$Checkbox is checked on the search screen. 
//Loop through each report row and rows where the $$HEX1$$1c20$$ENDHEX$$alloc_Qty$$HEX2$$1d202000$$ENDHEX$$field is > 0,
...
on w_empty_location_rpt_chinese.create
call super::create
end on

on w_empty_location_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_empty_location_rpt_chinese
integer x = 32
integer y = 4
integer width = 3525
integer height = 144
...
type cb_clear from w_std_report`cb_clear within w_empty_location_rpt_chinese
integer x = 3141
integer y = 240
end type

type dw_report from w_std_report`dw_report within w_empty_location_rpt_chinese
integer x = 14
integer y = 156
integer width = 3534
integer height = 1712
string dataobject = "d_empty_location_rpt_show_alloc_chinese"
boolean maxbox = true
boolean hscrollbar = true
end type

event dw_report::sqlpreview;call super::sqlpreview;//JXLIM 04/22/2010 Commented out all of the code in the $$HEX1$$1c20$$ENDHEX$$sqlpreview$$HEX2$$1d202000$$ENDHEX$$event. This is redundant since the SQL in the datawindow is now using Content_Summary instead of Content.
//
