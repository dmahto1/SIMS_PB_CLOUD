HA$PBExportHeader$w_delivery_rpt_chinese.srw
$PBExportComments$Delivery Report
forward
global type w_delivery_rpt_chinese from w_std_report
end type
end forward
...
global w_delivery_rpt_chinese w_delivery_rpt_chinese
...
on w_delivery_rpt_chinese.create
call super::create
end on

on w_delivery_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_delivery_rpt_chinese
integer x = 18
integer y = 0
integer width = 3648
integer height = 292
...
type cb_clear from w_std_report`cb_clear within w_delivery_rpt_chinese
end type

type dw_report from w_std_report`dw_report within w_delivery_rpt_chinese
integer x = 0
integer y = 300
integer width = 3625
integer height = 1592
integer taborder = 30
string dataobject = "d_delivery_rpt_chinese"
