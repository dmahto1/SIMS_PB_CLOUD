HA$PBExportHeader$w_cycle_count_rpt_chinese.srw
$PBExportComments$IAE Shipping Transaction Report
forward
global type w_cycle_count_rpt_chinese from w_std_report
end type
end forward
...
global w_cycle_count_rpt_chinese w_cycle_count_rpt_chinese
...
on w_cycle_count_rpt_chinese.create
call super::create
end on

on w_cycle_count_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_cycle_count_rpt_chinese
integer x = 5
integer y = 16
integer width = 2985
integer height = 168
...
type cb_clear from w_std_report`cb_clear within w_cycle_count_rpt_chinese
integer width = 293
integer height = 96
end type

type dw_report from w_std_report`dw_report within w_cycle_count_rpt_chinese
integer x = 14
integer y = 196
integer width = 3392
integer height = 1900
string dataobject = "d_cycle_count_rpt_chinese"
