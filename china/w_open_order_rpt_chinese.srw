HA$PBExportHeader$w_open_order_rpt_chinese.srw
$PBExportComments$This window is used for reporting the invoice information
forward
global type w_open_order_rpt_chinese from w_std_report
end type
end forward
...
global w_open_order_rpt_chinese w_open_order_rpt_chinese
...
on w_open_order_rpt_chinese.create
call super::create
end on

on w_open_order_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_open_order_rpt_chinese
integer y = 20
integer width = 3515
integer height = 104
string dataobject = "d_open_order_rpt_select_chinese"
...
type cb_clear from w_std_report`cb_clear within w_open_order_rpt_chinese
boolean visible = true
integer x = 3607
integer y = 24
end type

type dw_report from w_std_report`dw_report within w_open_order_rpt_chinese
integer y = 132
integer width = 3520
integer height = 1792
string dataobject = "d_open_order_rpt_chinese"
