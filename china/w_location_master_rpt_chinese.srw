HA$PBExportHeader$w_location_master_rpt_chinese.srw
$PBExportComments$Window used for Location Master Report
forward
global type w_location_master_rpt_chinese from w_std_report
end type
end forward
...
global w_location_master_rpt_chinese w_location_master_rpt_chinese
...
on w_location_master_rpt_chinese.create
call super::create
end on

on w_location_master_rpt_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_location_master_rpt_chinese
integer x = 32
integer height = 108
...
type cb_clear from w_std_report`cb_clear within w_location_master_rpt_chinese
end type

type dw_report from w_std_report`dw_report within w_location_master_rpt_chinese
integer x = 23
integer y = 116
integer width = 3502
integer height = 1800
string dataobject = "d_location_master_rpt_chinese"
