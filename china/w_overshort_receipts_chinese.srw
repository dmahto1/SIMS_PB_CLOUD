HA$PBExportHeader$w_overshort_receipts_chinese.srw
forward
global type w_overshort_receipts_chinese from w_std_report
end type
end forward
...
global w_overshort_receipts_chinese w_overshort_receipts_chinese

on w_overshort_receipts_chinese.create
call super::create
end on

on w_overshort_receipts_chinese.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_overshort_receipts_chinese
integer x = 23
integer y = 20
integer width = 3525
integer height = 128
...
type cb_clear from w_std_report`cb_clear within w_overshort_receipts_chinese
integer x = 2971
integer y = 32
end type

type dw_report from w_std_report`dw_report within w_overshort_receipts_chinese
integer x = 23
integer y = 160
integer width = 3525
integer height = 1768
string dataobject = "d_overshort_receipts_chinese"
boolean hscrollbar = true
end type

type gb_selectdate from groupbox within w_overshort_receipts_chinese
integer x = 27
integer width = 2885
integer height = 148
integer taborder = 20
...
type em_from_date from editmask within w_overshort_receipts_chinese
integer x = 1248
integer y = 52
integer width = 736
integer height = 80
...
type em_to_date from editmask within w_overshort_receipts_chinese
integer x = 2144
integer y = 48
integer width = 736
integer height = 80
...
type st_sfromdate from statictext within w_overshort_receipts_chinese
integer x = 69
integer y = 52
integer width = 1175
integer height = 72
...
type st_todate from statictext within w_overshort_receipts_chinese
integer x = 2011
integer y = 52
integer width = 133
integer height = 68
