HA$PBExportHeader$w_purchase_order_chinese.srw
$PBExportComments$Putaway Report
forward
global type w_purchase_order_chinese from w_std_report
end type
type cb_purchase_order_report_clear from commandbutton within w_purchase_order_chinese
end type
end forward
...
cb_purchase_order_report_clear cb_purchase_order_report_clear
end type
global w_purchase_order_chinese w_purchase_order_chinese
...
on w_purchase_order_chinese.create
int iCurrent
call super::create
this.cb_purchase_order_report_clear=create cb_purchase_order_report_clear
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.cb_purchase_order_report_clear
end on

on w_purchase_order_chinese.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.cb_purchase_order_report_clear)
end on
...
type dw_select from w_std_report`dw_select within w_purchase_order_chinese
integer x = 9
integer y = 0
integer width = 3854
integer height = 264
...
type cb_clear from w_std_report`cb_clear within w_purchase_order_chinese
integer x = 3913
integer y = 52
end type

type dw_report from w_std_report`dw_report within w_purchase_order_chinese
integer x = 5
integer y = 264
integer width = 4416
integer height = 1560
integer taborder = 30
string dataobject = "d_purchase_order_rpt_chinese"
