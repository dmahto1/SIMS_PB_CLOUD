HA$PBExportHeader$w_cycle_count_by_sku_chinese.srw
forward
global type w_cycle_count_by_sku_chinese from w_std_query_window
end type
end forward

global type w_cycle_count_by_sku_chinese from w_std_query_window
string title = "$$HEX7$$0963278dc154d876b970a5626888$$ENDHEX$$"
end type
global w_cycle_count_by_sku_chinese w_cycle_count_by_sku_chinese
...
on w_cycle_count_by_sku_chinese.create
call super::create
end on

on w_cycle_count_by_sku_chinese.destroy
call super::destroy
...
//
	...
	lstrparms.string_arg[2] = 'd_cc_report_by_sku_chinese'
...
type dw_select from w_std_query_window`dw_select within w_cycle_count_by_sku_chinese
end type

type cb_clear from w_std_query_window`cb_clear within w_cycle_count_by_sku_chinese
end type

type dw_report from w_std_query_window`dw_report within w_cycle_count_by_sku_chinese
end type
