HA$PBExportHeader$w_stock_movement_rpt_chinese.srw
forward
global type w_stock_movement_rpt_chinese from w_std_report
end type
end forward
...
global w_stock_movement_rpt_chinese w_stock_movement_rpt_chinese
...
on w_stock_movement_rpt_chinese.create
call super::create
end on

on w_stock_movement_rpt_chinese.destroy
call super::destroy
...
dw_report.SetFilter("")
dw_report.Filter()
//Jxlim 08/11/2010 Modifeid for Chinese report.
//dw_report.Object.t_date_range.text = 'None'
dw_report.Object.t_date_range.text = '$$HEX1$$f381$$ENDHEX$$'
...
IF ib_select_date_start and ib_select_date_end Then
      ls_filter =  "complete_date between  datetime('" +string(ldt_s) +"') and datetime('"+string(ldt_e)+"')"
		...
		//dw_report.Object.t_date_range.text = String(ldt_s,'mm/dd/yyyy hh:mm') + ' To ' + String(ldt_e,'mm/dd/yyyy hh:mm')
 		dw_report.Object.t_date_range.text = String(ldt_s,'mm/dd/yyyy hh:mm') + ' $$HEX2$$f3812000$$ENDHEX$$' + String(ldt_e,'mm/dd/yyyy hh:mm')
 END IF	
...
type dw_select from w_std_report`dw_select within w_stock_movement_rpt_chinese
integer x = 18
integer width = 3131
...
type cb_clear from w_std_report`cb_clear within w_stock_movement_rpt_chinese
integer x = 3154
integer y = 12
integer width = 270
end type
...
type dw_report from w_std_report`dw_report within w_stock_movement_rpt_chinese
integer y = 188
integer width = 3401
integer height = 1704
string dataobject = "d_stock_movement_rpt_by_sku_chinese"
