HA$PBExportHeader$w_inbound_order_rpt_chinese.srw
$PBExportComments$This is the Inbound Order report
forward
global type w_inbound_order_rpt_chinese from w_std_report
end type
end forward
...
global w_inbound_order_rpt_chinese w_inbound_order_rpt_chinese
...
on w_inbound_order_rpt_chinese.create
call super::create
end on

on w_inbound_order_rpt_chinese.destroy
call super::destroy
...
//Tackon BOL Nbr
IF NOT isnull(dw_select.GetItemString(1,"bol_no")) then
...
type dw_select from w_std_report`dw_select within w_inbound_order_rpt_chinese
integer x = 0
integer width = 3575
integer height = 316
...
type cb_clear from w_std_report`cb_clear within w_inbound_order_rpt_chinese
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_inbound_order_rpt_chinese
integer x = 0
integer y = 332
integer width = 3419
integer height = 1544
integer taborder = 30
string dataobject = "d_inbound_order_rpt_chinese"
