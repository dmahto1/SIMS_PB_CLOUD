HA$PBExportHeader$u_nvo_proc_sg_muser.sru
forward
...
//We have a change request from the user to insert the $$HEX1$$1820$$ENDHEX$$UOM1$$HEX2$$19202000$$ENDHEX$$field into the BOH report at the last column (X) in the Excel file. 	
