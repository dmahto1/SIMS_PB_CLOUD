HA$PBExportHeader$u_nvo_proc_nike_ewms.sru
forward
...
//-	SIMS Order number will be generated as $$HEX1$$1820$$ENDHEX$$RCTyyyymmxxxxx$$HEX2$$19202000$$ENDHEX$$where yyyy = year, mm=month and xxxxx is sequential number for the month.  The Next Sequence generator will return everything except the $$HEX1$$1820$$ENDHEX$$RCT$$HEX1$$1920$$ENDHEX$$. EWMS is currently storing this in the RO_NO but we will maintain our standard and store the RCT number in the Supp_invoice_No field.
...
//Consolidation is based on Cust_Code, Cust_Name, Address1 and Request_Date.  For SG, we also want to include Division (Item_Master.GRP). Do not consolidate if any value in $$HEX1$$1820$$ENDHEX$$Mark For Name$$HEX2$$19202000$$ENDHEX$$(UF8)  or $$HEX1$$1820$$ENDHEX$$MarkFor Address 1$$HEX2$$19202000$$ENDHEX$$(UF16)


For liIdx = 1 to  ldsSOdetail.RowCount() 

	//When loading orders, we will combine multiple Nike Delivery Notes into a single Menlo Order. Nike DN will be stored in Delivery_Detail UF1. ICC is mapping the DN to the Order Number (Invoice_No) but we will move it to DD.UF1 and create the order number as the $$HEX1$$1820$$ENDHEX$$SHP$$HEX2$$19202000$$ENDHEX$$number (see below)
...
//SIMS Order Number will be created as SHPyyyymmxxxxx where yyyy=year, mm=month and xxxxx = sequential number.  The Next Sequence generator will return everything except the $$HEX1$$1820$$ENDHEX$$SHP$$HEX1$$1920$$ENDHEX$$
...
//	MessageBox (lsOrderNumber, lsNewOrderNumber)	  
	...
	DO
		...
		if liFind > 0 then
			...
			//We will sequentially assign our own Line_Item_No since we are combining multiple order numbers. Nike$$HEX1$$1920$$ENDHEX$$s Line will be stored in User_line_Item
...
//If the first Char is $$HEX1$$1820$$ENDHEX$$T$$HEX2$$19202000$$ENDHEX$$and 4 thru 6 = $$HEX1$$1820$$ENDHEX$$LBL$$HEX1$$1920$$ENDHEX$$, then  set DD.UF3 = $$HEX1$$1820$$ENDHEX$$LBL$$HEX1$$1920$$ENDHEX$$
//If the first char = $$HEX1$$1820$$ENDHEX$$T$$HEX2$$19202000$$ENDHEX$$and 4 thru 6 = $$HEX1$$1820$$ENDHEX$$CAR$$HEX1$$1920$$ENDHEX$$, then set DD.UF4 = $$HEX1$$1820$$ENDHEX$$CAR$$HEX1$$1920$$ENDHEX$$
...
//-	When loading a new SKU, check the new serial_prefix table. If the first 2 char of the SKU match a table entry, set the Serial_Tracking_Ind to $$HEX1$$1820$$ENDHEX$$O$$HEX2$$19202000$$ENDHEX$$(outbound)
//
//-	Default Supp_code to $$HEX1$$1820$$ENDHEX$$NIKE$$HEX2$$19202000$$ENDHEX$$for new SKUs
//
//-	Load Division into GRP field. This is used in many functions/reports for Sorting and breaking
//
//-	$$HEX1$$1820$$ENDHEX$$Material Number$$HEX2$$19202000$$ENDHEX$$is col3 (sku)
//
//-	Size is UF1
//

//The Size should be loading into UF12 and we also need to be appending it to the end of the SKU coming in from ICC. 
//For example, In the file you loaded on the first, the first record has the SKU as $$HEX1$$1c20$$ENDHEX$$484890-010$$HEX1$$1d20$$ENDHEX$$. 
//	We should be appending the size so our SKU is $$HEX1$$1c20$$ENDHEX$$484890-010-S$$HEX1$$1d20$$ENDHEX$$, $$HEX1$$1c20$$ENDHEX$$494890-010-M$$HEX1$$1d20$$ENDHEX$$, $$HEX1$$1c20$$ENDHEX$$494890-010-L$$HEX1$$1d20$$ENDHEX$$,
//	$$HEX1$$1c20$$ENDHEX$$494890-010-XL$$HEX2$$1d202000$$ENDHEX$$, $$HEX1$$1c20$$ENDHEX$$494890-010-2XL$$HEX2$$1d202000$$ENDHEX$$and $$HEX1$$1c20$$ENDHEX$$494890-010-3XL$$HEX1$$1d20$$ENDHEX$$. 
//
...
//	End If	
	...
	//- $$HEX1$$1820$$ENDHEX$$Material Number$$HEX2$$19202000$$ENDHEX$$i
...
//entire format ($$HEX1$$1820$$ENDHEX$$yyyymmxxxxx$$HEX1$$1920$$ENDHEX$$) so the client doesn$$HEX1$$1920$$ENDHEX$$t need to determine the year and month.  
//At the beginning of the month we will bump up the month and if necessary the year (resetting the month to 01). 
//The client will just add the $$HEX1$$1820$$ENDHEX$$RCT$$HEX3$$192020002000$$ENDHEX$$or $$HEX1$$1820$$ENDHEX$$SHP$$HEX2$$19202000$$ENDHEX$$prefix after retrieving the next sequence number.
