HA$PBExportHeader$u_nvo_proc_pandora.sru
...
Long			llRowPos,llNewRow, llNewDetailRow ,llOrderSeq,	llBatchSeq,	llLineSeq, llTempRow,	&
				...
				ll_delivery_queue_count, ll_delivery_count, ll_delivery_detail_count, ll_change_request_nbr, ll_Row_Pos_Detail, lsCountInv, &
				ll_detail_error_count, ll_rc, ll_delivery_attr_count, ll_found, llNewNotesRow 
...
//		lsCrossDock_Loc = NoNull(lsCrossDock_loc )
		...
		*/
		If lsAction = 'D' then
			...
			If lsCountInv = 0 Then //Order is not found.  Set the OMC record to 'REJECTED' otherwise set to 'Accepted'
