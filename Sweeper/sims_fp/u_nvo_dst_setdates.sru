HA$PBExportHeader$u_nvo_dst_setdates.sru
forward
...
public function date getlastrundate ()
public subroutine setlastrundate ()
end prototypes
...
public function date getlastrundate ();// date = getLastRunDate()

// return the last run date
string lastRunDate


SELECT dbo.Lookup_Table.Code_ID  
INTO :lastRunDate
FROM dbo.Lookup_Table  
WHERE ( dbo.Lookup_Table.Project_ID = 'BASELINE' ) AND  
       		 ( dbo.Lookup_Table.Code_Type = 'DST' )           ;

return date( lastRunDate)

end function

public subroutine setlastrundate ();// setLastRunDate()
...
set dbo.Lookup_Table.Code_ID   = :lastRunDate
WHERE ( dbo.Lookup_Table.Project_ID = 'BASELINE' ) AND  
       		 ( dbo.Lookup_Table.Code_Type = 'DST' )  ;
