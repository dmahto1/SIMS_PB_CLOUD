...
//	We will only send to OTM where Delivery_Master.User_Field is $$HEX1$$1820$$ENDHEX$$SG00$$HEX2$$19202000$$ENDHEX$$or $$HEX1$$1820$$ENDHEX$$SG10$$HEX1$$1920$$ENDHEX$$
//delivery_master.user_field3
//	We will only send for new orders (I don$$HEX1$$1920$$ENDHEX$$t believe we get updates anyway)
...
// MEA 8/2018 - S22722
//At roughly line 70, there is logic that sets $$HEX1$$1c20$$ENDHEX$$lsProcessOTM$$HEX1$$1d20$$ENDHEX$$. 
//After this IF statement, add logic to retrieve the table entry above based on the warehouse for the current order. 
//If a record is found, set $$HEX1$$1c20$$ENDHEX$$lsProcessOTM$$HEX2$$1d202000$$ENDHEX$$= $$HEX1$$1c20$$ENDHEX$$N$$HEX1$$1d20$$ENDHEX$$.
