HA$PBExportHeader$u_nvo_edi_confirmations_baseline_unicode.sru
$PBExportComments$Process outbound edi confirmation transactions for Powerwave
forward
global type u_nvo_edi_confirmations_baseline_unicode from nonvisualobject
end type
end forward

global type u_nvo_edi_confirmations_baseline_unicode from nonvisualobject
end type
global u_nvo_edi_confirmations_baseline_unicode u_nvo_edi_confirmations_baseline_unicode
...
on u_nvo_edi_confirmations_baseline_unicode.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_nvo_edi_confirmations_baseline_unicode.destroy
