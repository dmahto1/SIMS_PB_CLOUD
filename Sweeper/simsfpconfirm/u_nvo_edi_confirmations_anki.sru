HA$PBExportHeader$u_nvo_edi_confirmations_anki.sru
$PBExportComments$Process outbound edi confirmation transactions for Powerwave
forward
global type u_nvo_edi_confirmations_anki from nonvisualobject
end type
end forward

global type u_nvo_edi_confirmations_anki from nonvisualobject
end type
global u_nvo_edi_confirmations_anki u_nvo_edi_confirmations_anki
...
public function integer uf_gi (string asproject, string asdono);//Jxlim 09/05/2014 Jxlim Outbound order confirmation
...
// TAM 2015/06  Get quantity scanned from the serial table
//		lsOutString += '1' + lsDelimitChar
	...
	//GI018 Ship Tracking Number	C(25)	No	N/A		we are not sending anything on GI018 positiong
...
//	End If	
	...
	Else
//		lsOutString +=lsDelimitChar  //End, do not need delimeter
	End If		
...
on u_nvo_edi_confirmations_anki.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_nvo_edi_confirmations_anki.destroy
