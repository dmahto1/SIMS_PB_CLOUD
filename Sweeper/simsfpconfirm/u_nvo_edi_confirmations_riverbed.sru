HA$PBExportHeader$u_nvo_edi_confirmations_riverbed.sru
...
//I$$HEX1$$1920$$ENDHEX$$m suggesting that we use Order Infor.User Field2 for ops to key in the wordings $$HEX1$$1c20$$ENDHEX$$Manual$$HEX2$$1d202000$$ENDHEX$$and once the work order is confirmed, 
//SIMS Sweeper do not generate EDI for such work orders. Is this suggestion feasible, and if yes, what$$HEX1$$1920$$ENDHEX$$s the additional IT hours required? 
...
End If
	...
	//Record_ID	C(2)	Yes	$$HEX1$$1c20$$ENDHEX$$WM$$HEX2$$1d200900$$ENDHEX$$Goods receipt confirmation identifier
lsOutString = ''
