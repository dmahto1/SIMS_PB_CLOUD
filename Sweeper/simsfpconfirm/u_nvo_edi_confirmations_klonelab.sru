HA$PBExportHeader$u_nvo_edi_confirmations_klonelab.sru
$PBExportComments$Process outbound edi confirmation transactions for Powerwave
forward
global type u_nvo_edi_confirmations_klonelab from nonvisualobject
end type
end forward

global type u_nvo_edi_confirmations_klonelab from nonvisualobject
end type
global u_nvo_edi_confirmations_klonelab u_nvo_edi_confirmations_klonelab
...
on u_nvo_edi_confirmations_klonelab.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_nvo_edi_confirmations_klonelab.destroy
