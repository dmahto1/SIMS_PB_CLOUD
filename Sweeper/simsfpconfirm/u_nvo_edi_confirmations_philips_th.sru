HA$PBExportHeader$u_nvo_edi_confirmations_philips_th.sru
forward
global type u_nvo_edi_confirmations_philips_th from nonvisualobject
end type
end forward

global type u_nvo_edi_confirmations_philips_th from nonvisualobject
end type
global u_nvo_edi_confirmations_philips_th u_nvo_edi_confirmations_philips_th
...
For llRowPos = 1 to llRowCOunt
	...
	idsOut.SetItem(llNewRow,'Project_id', 'Philips-TH')
...
gu_nvo_process_files.uf_process_flatfile_outbound(idsOut,'Philips-TH')
...
For llRowPos = 1 to llRowCount
	...
	Else /*not found, add a new record*/
		...
		If llDetailFindRow > 0 Then
			...
			idsGR.SetItem(llNewRow,'user_field4',idsRoDetail.GetItemString(llDetailFindRow,'user_field4')) //21-Jan-2019 :Madhu S28291 SAP Original Inv Types
		End If
...
For llRowPos = 1 to llRowCOunt
	...
	//GailM 3/8/2019 DE9277 user_field4 is NULL, wrap it in nz function 
	lsOutString += nz(idsGR.GetItemString(llRowPos,'user_field4'),"") + '|' //21-Jan-2019 :Madhu S28291 Origial SAP Inv Types
...
//MEA - 12/11
//I just received TH Country Manager approved. Kindly make the changes so that no output 
//file generated for those adjustment record  having following condition

//a.	FROM inventory type =  $$HEX1$$1c20$$ENDHEX$$N$$HEX2$$1d202000$$ENDHEX$$
//b.	FROM  inventory type = $$HEX2$$1c202000$$ENDHEX$$T$$HEX1$$1d20$$ENDHEX$$
//c.	TO inventory type = $$HEX1$$1c20$$ENDHEX$$N$$HEX2$$1d202000$$ENDHEX$$
//d.	TO inventory type = $$HEX2$$1c202000$$ENDHEX$$T$$HEX1$$1d20$$ENDHEX$$

//Let me know when this is done and I will assign  the Philips TH ops team on the testing.
...
on u_nvo_edi_confirmations_philips_th.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_nvo_edi_confirmations_philips_th.destroy
