HA$PBExportHeader$u_nvo_edi_confirmations_kinderdijk.sru
...
//The filename is prefix by a $$HEX1$$1820$$ENDHEX$$C_$$HEX2$$19202000$$ENDHEX$$or $$HEX1$$1820$$ENDHEX$$O_$$HEX2$$19202000$$ENDHEX$$+ the Order Number [E.g. C_DC-14086.csv , O_DC12345.csv]
...
For llRowPos = 1 to llRowCOunt
	...
	//'Test Description$$HEX2$$19202000$$ENDHEX$$and double quotes are removed. requierment changed
