HA$PBExportHeader$w_delivery_by_sku_rpt.srw
$PBExportComments$Delivery by SKU Report
forward
global type w_delivery_by_sku_rpt from w_std_report
end type
end forward
...
global w_delivery_by_sku_rpt w_delivery_by_sku_rpt
...
on w_delivery_by_sku_rpt.create
call super::create
end on

on w_delivery_by_sku_rpt.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_delivery_by_sku_rpt
integer y = 20
integer width = 3424
integer height = 168
...
type cb_clear from w_std_report`cb_clear within w_delivery_by_sku_rpt
end type

type dw_report from w_std_report`dw_report within w_delivery_by_sku_rpt
integer x = 14
integer y = 200
integer width = 3566
integer height = 1708
string dataobject = "d_delivery_by_sku_rpt"
