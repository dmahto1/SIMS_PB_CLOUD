HA$PBExportHeader$w_exception_rpt.srw
$PBExportComments$Allocation Report
forward
global type w_exception_rpt from w_std_report
end type
end forward
...
global w_exception_rpt w_exception_rpt
...
on w_exception_rpt.create
call super::create
end on

on w_exception_rpt.destroy
call super::destroy
...
llRowCount  = dw_report.Retrieve(gs_project,ldt_start, ldt_end)
...
//		lsSort = "delivery_master_wh_code A, delivery_master_invoice_no A, Delivery_Detail_Line_Line_Item_No A"
//	Case 'P' /*priority*/
...
dw_report.SetFilter("IsNull(qty_available) OR qty_available <> qty_required")
dw_report.Filter()
...
type dw_select from w_std_report`dw_select within w_exception_rpt
boolean visible = false
integer x = 18
integer y = 2064
integer width = 3351
integer height = 364
string dataobject = "d_exception_rpt_search"
...
type cb_clear from w_std_report`cb_clear within w_exception_rpt
integer x = 3154
integer y = 20
integer width = 55
integer height = 64
...
type dw_report from w_std_report`dw_report within w_exception_rpt
integer x = 14
integer y = 8
integer width = 3625
integer height = 1968
integer taborder = 30
string dataobject = "d_exception_rpt"
