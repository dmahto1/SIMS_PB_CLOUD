HA$PBExportHeader$w_prior_day_receipt_report.srw
$PBExportComments$Allocation Report
forward
global type w_prior_day_receipt_report from w_std_report
end type
end forward
...
integer width = 3730
integer height = 2244
string title = "Prior Day Receipts Report"
event ue_allocate ( )
end type
global w_prior_day_receipt_report w_prior_day_receipt_report
...
on w_prior_day_receipt_report.create
call super::create
end on

on w_prior_day_receipt_report.destroy
call super::destroy
...
If date(dw_select.GetItemDateTime(1,"from_SChed_Date")) > date('01-01-1900') Then
	...
	is_Where += "  and Receive_master.Complete_Date >= '" + string(dw_select.GetItemDateTime(1,"from_SChed_Date"),'mm-dd-yyyy hh:mm') + "' "
End If
...
If date(dw_select.GetItemDateTime(1,"to_SChed_Date")) > date('01-01-1900') Then
	...
	is_Where += " and Receive_master.Complete_Date <= '" + string(dw_select.GetItemDateTime(1,"to_SChed_Date"),'mm-dd-yyyy hh:mm') + "' "
End If
...
// From To Date
dw_select.SetItem(1,"from_SChed_Date", datetime( RelativeDate ( today(), -1 ), time("00:00:00")))
...
type dw_select from w_std_report`dw_select within w_prior_day_receipt_report
integer x = 14
integer y = 4
integer width = 3351
integer height = 292
string dataobject = "d_prior_day_receipt_report_search"
...
type cb_clear from w_std_report`cb_clear within w_prior_day_receipt_report
integer x = 3154
integer y = 20
integer width = 55
integer height = 64
...
type dw_report from w_std_report`dw_report within w_prior_day_receipt_report
integer x = 14
integer y = 336
integer width = 3625
integer height = 1672
integer taborder = 30
string dataobject = "d_prior_day_receipt_report"
