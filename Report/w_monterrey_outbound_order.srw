HA$PBExportHeader$w_monterrey_outbound_order.srw
$PBExportComments$OutBound Order Report (GAP - 8/02)
forward
global type w_monterrey_outbound_order from w_std_report
end type
type uo_order_status_search from uo_multi_select_search within w_monterrey_outbound_order
end type
end forward
...
global w_monterrey_outbound_order w_monterrey_outbound_order
...
on w_monterrey_outbound_order.create
int iCurrent
call super::create
...
on w_monterrey_outbound_order.destroy
call super::destroy
...
type dw_select from w_std_report`dw_select within w_monterrey_outbound_order
...
type cb_clear from w_std_report`cb_clear within w_monterrey_outbound_order
integer taborder = 20
end type

type dw_report from w_std_report`dw_report within w_monterrey_outbound_order
integer x = 5
integer y = 460
integer width = 3429
integer height = 1400
integer taborder = 30
string dataobject = "d_monterrey_outbound_orders"
