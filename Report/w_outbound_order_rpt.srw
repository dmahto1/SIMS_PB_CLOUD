HA$PBExportHeader$w_outbound_order_rpt.srw
$PBExportComments$This is the Outbound Order report
forward
global type w_outbound_order_rpt from w_std_report
end type
end forward
...
global w_outbound_order_rpt w_outbound_order_rpt
...
on w_outbound_order_rpt.create
call super::create
end on

on w_outbound_order_rpt.destroy
call super::destroy
...
If gs_project = 'PANDORA' Then
	dw_report.dataobject = 'd_pandora_outbound_order_rpt'
...
type dw_select from w_std_report`dw_select within w_outbound_order_rpt
integer y = 16
integer width = 1728
integer height = 80
...
type cb_clear from w_std_report`cb_clear within w_outbound_order_rpt
end type

type dw_report from w_std_report`dw_report within w_outbound_order_rpt
integer x = 14
integer y = 108
integer width = 3566
integer height = 1800
string dataobject = "d_outbound_order_rpt"
