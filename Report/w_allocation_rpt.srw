HA$PBExportHeader$w_allocation_rpt.srw
$PBExportComments$Allocation Report
forward
global type w_allocation_rpt from w_std_report
end type
end forward
...
global w_allocation_rpt w_allocation_rpt
...
on w_allocation_rpt.create
call super::create
end on

on w_allocation_rpt.destroy
call super::destroy
...
If gs_project = 'PANDORA' Then
	dw_report.dataobject = 'd_pandora_allocation_rpt'
...
type dw_select from w_std_report`dw_select within w_allocation_rpt
integer x = 18
integer y = 0
integer width = 3351
integer height = 364
...
type cb_clear from w_std_report`cb_clear within w_allocation_rpt
integer x = 3154
integer y = 20
integer width = 55
integer height = 64
...
type dw_report from w_std_report`dw_report within w_allocation_rpt
integer x = 0
integer y = 376
integer width = 3625
integer height = 1516
integer taborder = 30
string dataobject = "d_allocation_rpt"
